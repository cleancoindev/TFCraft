...
import com.dunk.tfc.Handlers.BiomeEventHandler;
import com.dunk.tfc.Handlers.PlayerExtraInfoMessage;
import com.dunk.tfc.Handlers.Client.ArmourStandHighlightHandler;
import com.dunk.tfc.Handlers.Client.BlockRenderHandler;
import com.dunk.tfc.Handlers.Client.ChiselHighlightHandler;
import com.dunk.tfc.Handlers.Client.ClientTickHandler;
import com.dunk.tfc.Handlers.Client.FMLClientEventHandler;
import com.dunk.tfc.Handlers.Client.FamiliarityHighlightHandler;
import com.dunk.tfc.Handlers.Client.FarmlandHighlightHandler;
import com.dunk.tfc.Handlers.Client.FogHandler;
import com.dunk.tfc.Handlers.Client.GuiHandler;
import com.dunk.tfc.Handlers.Client.KeyBindingHandler;
import com.dunk.tfc.Handlers.Client.PlankHighlightHandler;
import com.dunk.tfc.Handlers.Client.PlayerRenderHandler;
import com.dunk.tfc.Handlers.Client.RenderOverlayHandler;
import com.dunk.tfc.Handlers.Client.SoundHandler;
import com.dunk.tfc.Render.EntityRendererTFC;
import com.dunk.tfc.Render.FoliageColorReloadListener;
import com.dunk.tfc.Render.GrassColorReloadListener;
import com.dunk.tfc.Render.RenderBarrelEntity;
import com.dunk.tfc.Render.RenderBear;
import com.dunk.tfc.Render.RenderChickenTFC;
import com.dunk.tfc.Render.RenderCowTFC;
import com.dunk.tfc.Render.RenderDeer;
import com.dunk.tfc.Render.RenderEntityCorpse;
import com.dunk.tfc.Render.RenderEntityStand;
import com.dunk.tfc.Render.RenderFallingBlock;
import com.dunk.tfc.Render.RenderFishTFC;
import com.dunk.tfc.Render.RenderHorseTFC;
import com.dunk.tfc.Render.RenderPheasantTFC;
import com.dunk.tfc.Render.RenderPigTFC;
import com.dunk.tfc.Render.RenderSheepTFC;
import com.dunk.tfc.Render.RenderSkeletonTFC;
import com.dunk.tfc.Render.RenderSquidTFC;
import com.dunk.tfc.Render.RenderTerraJavelin;
import com.dunk.tfc.Render.RenderWolfTFC;
import com.dunk.tfc.Render.Blocks.RenderAnvil;
import com.dunk.tfc.Render.Blocks.RenderBarrel;
import com.dunk.tfc.Render.Blocks.RenderBasket;
import com.dunk.tfc.Render.Blocks.RenderBellows;
...
import com.dunk.tfc.Render.Blocks.RenderMetalTrapDoor;
import com.dunk.tfc.Render.Blocks.RenderNestBox;
import com.dunk.tfc.Render.Blocks.RenderOilLamp;
import com.dunk.tfc.Render.Blocks.RenderOre;
import com.dunk.tfc.Render.Blocks.RenderPottery;
import com.dunk.tfc.Render.Blocks.RenderSmoke;
...
import com.dunk.tfc.Render.Models.ModelBass;
import com.dunk.tfc.Render.Models.ModelBear;
import com.dunk.tfc.Render.Models.ModelChickenTFC;
import com.dunk.tfc.Render.Models.ModelCowTFC;
import com.dunk.tfc.Render.Models.ModelDeer;
import com.dunk.tfc.Render.Models.ModelHorseTFC;
import com.dunk.tfc.Render.Models.ModelPheasant;
import com.dunk.tfc.Render.Models.ModelPigTFC;
import com.dunk.tfc.Render.Models.ModelSheep1TFC;
import com.dunk.tfc.Render.Models.ModelSheep2TFC;
import com.dunk.tfc.Render.Models.ModelSquidTFC;
import com.dunk.tfc.Render.Models.ModelWolfTFC;
import com.dunk.tfc.Render.TESR.TESRAnvil;
import com.dunk.tfc.Render.TESR.TESRBellows;
import com.dunk.tfc.Render.TESR.TESRChest;
import com.dunk.tfc.Render.TESR.TESRFirepit;
import com.dunk.tfc.Render.TESR.TESRFoodPrep;
import com.dunk.tfc.Render.TESR.TESRGrill;
import com.dunk.tfc.Render.TESR.TESRHopper;
import com.dunk.tfc.Render.TESR.TESRIngotPile;
import com.dunk.tfc.Render.TESR.TESRLoom;
import com.dunk.tfc.Render.TESR.TESRMetalSheet;
import com.dunk.tfc.Render.TESR.TESRPottery;
import com.dunk.tfc.Render.TESR.TESRQuern;
import com.dunk.tfc.Render.TESR.TESRSmokeRack;
import com.dunk.tfc.Render.TESR.TESRToolrack;
import com.dunk.tfc.Render.TESR.TESRWorldItem;
...
public class ClientProxy extends CommonProxy
{
	...
	public void registerRenderInformation()
	{
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCorpse.class, new RenderEntityCorpse(new ModelBase[] {new ModelBear(), new ModelChickenTFC(), new ModelCowTFC(), new ModelDeer(), new ModelBass(), new ModelHorseTFC(), new ModelPheasant(), new ModelPigTFC(), new ModelSheep2TFC(), new ModelWolfTFC()},new ModelSheep1TFC(), 0.9F));
		...
		RenderingRegistry.registerBlockHandler(TFCBlocks.floraRenderId = RenderingRegistry.getNextAvailableRenderId(), new BlockRenderHandler());
		...
		RenderingRegistry.registerBlockHandler(TFCBlocks.branchRenderId = RenderingRegistry.getNextAvailableRenderId(), new RenderBranch());
	...
	{
		TerraFirmaCraft.netWrapper.registerMessage(PlayerExtraInfoMessage.Handler.class, PlayerExtraInfoMessage.class, 0, Side.CLIENT);
	...
	public void registerTileEntities(boolean b)
	{
		...
		ClientRegistry.registerTileEntity(TEMetalSheet.class, "metalSheet", new TESRMetalSheet());
	...
	public int grassColorMultiplier(IBlockAccess par1IBlockAccess, int i, int j, int k)
	{
		...
		int ans = (var5 / 9 & 255) << 16 | (var6 / 9 & 255) << 8 | var7 / 9 & 255;
		return ans;
	}
