...
public class CropManager
{
	...
	static
	{
		INSTANCE.addIndex(new CropIndex(/*ID*/0, /*Name*/"wheat", /*type*/0, /*time*/32, /*stages*/7, /*minGTemp*/4, /*minATemp*/0, /*nutrientUsage*/0.9f, TFCItems.seedsWheat).setOutput1(TFCItems.wheatWhole, 14.0f*2));
		...
		INSTANCE.addIndex(new CropIndex(/*ID*/3, /*Name*/"barley", /*type*/0, /*time*/33, /*stages*/7, /*minGTemp*/4, /*minATemp*/0, /*nutrientUsage*/0.85f, TFCItems.seedsBarley).setOutput1(TFCItems.barleyWhole, 14.0f*2));

		INSTANCE.addIndex(new CropIndex(/*ID*/4, /*Name*/"rye", /*type*/0, /*time*/32, /*stages*/7, /*minGTemp*/4, /*minATemp*/0, /*nutrientUsage*/0.9f, TFCItems.seedsRye).setOutput1(TFCItems.ryeWhole, 14.0f*2));

		INSTANCE.addIndex(new CropIndex(/*ID*/5, /*Name*/"oat", /*type*/0, /*time*/32, /*stages*/7, /*minGTemp*/4, /*minATemp*/0, /*nutrientUsage*/0.9f, TFCItems.seedsOat).setWaterUsage(1.4f).setOutput1(TFCItems.oatWhole, 14.0f*2));

		INSTANCE.addIndex(new CropIndex(/*ID*/6, /*Name*/"rice", /*type*/1, /*time*/32, /*stages*/7, /*minGTemp*/4, /*minATemp*/0, /*nutrientUsage*/0.9f, TFCItems.seedsRice).setWaterUsage(1.1f).setOutput1(TFCItems.riceWhole, 14.0f*2));
		...
		INSTANCE.addIndex(new CropIndexJute(/*ID*/19, /*Name*/"flax", /*type*/1, /*time*/24, /*stages*/5, /*minGTemp*/10, /*minATemp*/5, /*nutrientUsage*/1.0f, TFCItems.seedsFlax).setOutput1(TFCItems.flax, 3));
		INSTANCE.addIndex(new CropIndexJute(/*ID*/20, /*Name*/"madder", /*type*/2, /*time*/35, /*stages*/4, /*minGTemp*/10, /*minATemp*/5, /*nutrientUsage*/0.4f, TFCItems.seedsMadder).setOutput1(TFCItems.madderRoot, 2));
		INSTANCE.addIndex(new CropIndexJute(/*ID*/21, /*Name*/"weld", /*type*/3, /*time*/30, /*stages*/4, /*minGTemp*/10, /*minATemp*/5, /*nutrientUsage*/0.4f, TFCItems.seedsWeld).setOutput1(TFCItems.weldRoot, 2));
		INSTANCE.addIndex(new CropIndexJute(/*ID*/22, /*Name*/"woad", /*type*/1, /*time*/34, /*stages*/5, /*minGTemp*/16, /*minATemp*/10, /*nutrientUsage*/0.2f, TFCItems.seedsWoad).setOutput1(TFCItems.woadLeaves, 3));
