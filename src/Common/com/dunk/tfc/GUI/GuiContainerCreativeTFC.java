...
import com.dunk.tfc.Containers.ContainerCreativeTFC;
...
public class GuiContainerCreativeTFC extends InventoryEffectRenderer
{
	...
	private static InventoryBasic inventory = new InventoryBasic("tmp", true, 55);
	...
	{
		if (isMouseOverSlot((Slot) this.inventorySlots.inventorySlots.get(50), par2, par3))
		{
	...
	private void setCurrentCreativeTab(CreativeTabs par1CreativeTabs)
	{
		...
		if (par1CreativeTabs == CreativeTabs.tabInventory)
		{
			...
			for (int j = 0; j < container.inventorySlots.size(); ++j)
			{
				...
				{
					slotcreativeinventory.xDisplayPosition = -9;
					slotcreativeinventory.yDisplayPosition = 33;
				}
				else if(j==51)	//hat
				{
					slotcreativeinventory.xDisplayPosition = 27;
				...
				{
					slotcreativeinventory.xDisplayPosition = 81;
					slotcreativeinventory.yDisplayPosition = 6;
				}
				else if(j==54)	//socks
				{
