...
public class TFC_Sounds
{
	...
	public static final String BONEBREAK = LOCATION + "item.bonebreak";
	public static final String FIRESTARTER = LOCATION + "item.firestarter";
	public static final String CONCH = LOCATION + "item.conch";
	public static final String HORN = LOCATION + "item.horn";
	public static final String BRASSHORN = LOCATION + "item.brasshorn";
	public static final String BONGO = LOCATION + "item.bongo.hit";
	public static final String DRUM = LOCATION + "item.drum.hit";
	public static final String DRUMRIM = LOCATION + "item.drum.rim";
	public static final String JUGBLOW = LOCATION + "item.jug.blow";
	public static final String BRANCHSNAP = LOCATION + "block.branch.snap2";
	public static final String TWIGSNAP = LOCATION + "block.branch.snap1";
	public static final String LYRE = LOCATION + "item.lyre.strum";
	public static final String JUGBLOWNOTE = LOCATION + "item.jug.blow2";
	public static final String JUGBLOWNOTE2 = LOCATION + "item.jug.blow3";
	public static final String KNAP1 = LOCATION + "gui.knapping.rock1";
	public static final String KNAP2 = LOCATION + "gui.knapping.rock2";
