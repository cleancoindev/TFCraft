...
import static com.dunk.tfc.Reference.MOD_ID;
import static com.dunk.tfc.WorldGen.Generators.WorldGenOre.oreList;
import static com.dunk.tfc.api.TFCOptions.animalTimeMultiplier;
import static com.dunk.tfc.api.TFCOptions.anvilRuleColor0;
import static com.dunk.tfc.api.TFCOptions.anvilRuleColor1;
import static com.dunk.tfc.api.TFCOptions.anvilRuleColor2;
import static com.dunk.tfc.api.TFCOptions.bloomeryBurnTime;
import static com.dunk.tfc.api.TFCOptions.charcoalPitBurnTime;
import static com.dunk.tfc.api.TFCOptions.cropFertilizerColor;
import static com.dunk.tfc.api.TFCOptions.cropGrowthMultiplier;
import static com.dunk.tfc.api.TFCOptions.cropNutrientAColor;
import static com.dunk.tfc.api.TFCOptions.cropNutrientBColor;
import static com.dunk.tfc.api.TFCOptions.cropNutrientCColor;
import static com.dunk.tfc.api.TFCOptions.decayMultiplier;
import static com.dunk.tfc.api.TFCOptions.decayProtectionDays;
import static com.dunk.tfc.api.TFCOptions.enableBetterGrass;
import static com.dunk.tfc.api.TFCOptions.enableCaveIns;
import static com.dunk.tfc.api.TFCOptions.enableCaveInsDestroyOre;
...
import static com.dunk.tfc.api.TFCOptions.enablePowderKegs;
import static com.dunk.tfc.api.TFCOptions.enableSaplingDrops;
import static com.dunk.tfc.api.TFCOptions.enableSeedDrops;
import static com.dunk.tfc.api.TFCOptions.enableSolidDetailed;
import static com.dunk.tfc.api.TFCOptions.enableToolModeIndicator;
import static com.dunk.tfc.api.TFCOptions.foodDecayRate;
import static com.dunk.tfc.api.TFCOptions.goldPanLimit;
import static com.dunk.tfc.api.TFCOptions.healthGainCap;
import static com.dunk.tfc.api.TFCOptions.healthGainRate;
import static com.dunk.tfc.api.TFCOptions.initialCollapseRatio;
import static com.dunk.tfc.api.TFCOptions.lavaFissureRarity;
import static com.dunk.tfc.api.TFCOptions.maxProtectionMonths;
import static com.dunk.tfc.api.TFCOptions.maxRemovedSolidDetailed;
import static com.dunk.tfc.api.TFCOptions.minimumRockLoad;
import static com.dunk.tfc.api.TFCOptions.normalOreUnits;
import static com.dunk.tfc.api.TFCOptions.oilLampFuelMult;
import static com.dunk.tfc.api.TFCOptions.onionsAreGross;
import static com.dunk.tfc.api.TFCOptions.pitKilnBurnTime;
import static com.dunk.tfc.api.TFCOptions.poorOreUnits;
import static com.dunk.tfc.api.TFCOptions.propogateCollapseChance;
import static com.dunk.tfc.api.TFCOptions.protectionBuffer;
import static com.dunk.tfc.api.TFCOptions.protectionGain;
import static com.dunk.tfc.api.TFCOptions.quiverHUDPosition;
import static com.dunk.tfc.api.TFCOptions.ravineRarity;
import static com.dunk.tfc.api.TFCOptions.richOreUnits;
import static com.dunk.tfc.api.TFCOptions.saplingTimerMultiplier;
import static com.dunk.tfc.api.TFCOptions.simSpeedNoPlayers;
import static com.dunk.tfc.api.TFCOptions.sluiceLimit;
import static com.dunk.tfc.api.TFCOptions.smallOreUnits;
import static com.dunk.tfc.api.TFCOptions.tempDecreaseMultiplier;
import static com.dunk.tfc.api.TFCOptions.tempIncreaseMultiplier;
import static com.dunk.tfc.api.TFCOptions.torchBurnTime;
import static com.dunk.tfc.api.TFCOptions.useDecayProtection;
import static com.dunk.tfc.api.TFCOptions.waterFissureRarity;
import static com.dunk.tfc.api.TFCOptions.yearLength;
...
import com.dunk.tfc.Core.Util.CaseInsensitiveHashMap;
