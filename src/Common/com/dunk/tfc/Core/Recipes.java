...
public class Recipes
{
	...
	public static void registerRecipes()
	{
		...
		/*
		 * Item[] Ingots = {TFCItems.BismuthIngot,
		 * TFCItems.BismuthBronzeIngot,TFCItems.BlackBronzeIngot,
		 * TFCItems.BlackSteelIngot,TFCItems.BlueSteelIngot,TFCItems.BrassIngot,
		 * TFCItems.BronzeIngot,
		 * TFCItems.BronzeIngot,TFCItems.CopperIngot,TFCItems.GoldIngot,TFCItems
		 * .WroughtIronIngot,TFCItems.LeadIngot,
		 * TFCItems.NickelIngot,TFCItems.PigIronIngot,TFCItems.PlatinumIngot,
		 * TFCItems.RedSteelIngot,
		 * TFCItems.RoseGoldIngot,TFCItems.SilverIngot,TFCItems.SteelIngot,
		 * TFCItems.SterlingSilverIngot, TFCItems.TinIngot,TFCItems.ZincIngot};
		 */

		// Remove Vanilla recipes before adding TFC recipes for oredict
		// compatibility
		vanillaRecipes();
		...
		for (int i = 0; i < Global.WOOD_ALL.length; i++)
		{
			...
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.chest, 1, i), "###", "# #", "###", '#',
					new ItemStack(TFCItems.singlePlank, 1, i)));
			...
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(TFCItems.singlePlank, 8, i),
					new ItemStack(TFCItems.logs, 1, 2 * i), "itemSaw"));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(TFCItems.singlePlank, 8, i),
					new ItemStack(TFCItems.logs, 1, 2 * i + 1), "itemSaw"));
			...
			if (i == l)
			{
				GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(TFCItems.singlePlank, 4, i),
						new ItemStack(TFCBlocks.planks, 1, i), "itemSaw"));

				GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.woodSupportV, 8, i), "A2", " 2", '2',
						new ItemStack(TFCItems.logs, 1, 2 * i), 'A', "itemSaw"));
				GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.woodSupportV, 8, i), "A2", " 2", '2',
						new ItemStack(TFCItems.logs, 1, 2 * i + 1), 'A', "itemSaw"));
				...
				GameRegistry.addRecipe(new ItemStack(TFCBlocks.fence, 6, i), "LPL", "LPL", 'L',
						new ItemStack(TFCItems.logs, 1, 2 * i), 'P', new ItemStack(TFCItems.singlePlank, 1, i));
				GameRegistry.addRecipe(new ItemStack(TFCBlocks.fence, 6, i), "LPL", "LPL", 'L',
			...
			else if (i / 16 == 1)
			{
				...
				// ItemStack(TFCItems.singlePlank, 8, i), new
				// ItemStack(TFCItems.logs, 1, i), "itemSaw"));
				GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(TFCItems.singlePlank, 4, i),
						new ItemStack(TFCBlocks.planks2, 1, l), "itemSaw"));
				GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.woodSupportV2, 8, l), "A2", " 2",
						'2', new ItemStack(TFCItems.logs, 1, 2 * i), 'A', "itemSaw"));
				GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.woodSupportV2, 8, l), "A2", " 2",
						'2', new ItemStack(TFCItems.logs, 1, 2 * i + 1), 'A', "itemSaw"));

				GameRegistry.addRecipe(new ItemStack(TFCBlocks.planks2, 1, l), "11", "11", '1',
						new ItemStack(TFCItems.singlePlank, 1, i));

				GameRegistry.addRecipe(new ItemStack(TFCBlocks.fence2, 6, l), "LPL", "LPL", 'L',
						new ItemStack(TFCItems.logs, 1, 2 * i), 'P', new ItemStack(TFCItems.singlePlank, 1, i));
				GameRegistry.addRecipe(new ItemStack(TFCBlocks.fence2, 6, l), "LPL", "LPL", 'L',
						new ItemStack(TFCItems.logs, 1, 2 * i + 1), 'P', new ItemStack(TFCItems.singlePlank, 1, i));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.sluiceItem, 1), "  1", " 12", "122", '1',
				"stickWood", '2', "woodLumber"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.nestBox, 1), "S S", "PSP", "PPP", 'S',
				new ItemStack(TFCItems.straw, 1), 'P', "woodLumber"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.woodenBucketEmpty, 1), "w w", "w w", " w ",
				'w', "woodLumber"));
		GameRegistry
				.addRecipe(new ShapedOreRecipe(new ItemStack(Blocks.trapdoor, 1, 0), "###", "###", '#', "woodLumber"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(Items.sign, 1, 0), "###", "###", " 1 ", '#',
				"woodLumber", '1', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.buttonWood, 1), "#", '#', "plankWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.woodenBucketEmpty, 1), "#", '#',
				TFCItems.woodenBucketGypsum));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(Items.bed, 1), "PPP", "QQQ", 'P', "materialCloth", 'Q',
				"woodLumber"));
		GameRegistry
				.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.workbench, 1), "PP", "PP", 'P', "plankWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.bellows, 1, 0), "###", "???", "###", '#',
				"woodLumber", '?', "materialLeather"));

		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.burlapSack, 3, 0), "##", '#',
				new ItemStack(TFCItems.burlapCloth, 1)));

		// Hide & Sheepskin
		for (int k = 0; k < 3; k++)
		{
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(TFCItems.wool, 1 + k, 0),
					new ItemStack(TFCItems.sheepSkin, 1, k), "itemKnife"));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(TFCItems.hide, 1, k),
					new ItemStack(TFCItems.wolfFur, 1, k), "itemKnife"));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(TFCItems.hide, 1, k),
					new ItemStack(TFCItems.bearFur, 1, k), "itemKnife"));
		}
		...
		GameRegistry.addShapelessRecipe(new ItemStack(TFCItems.dye, 1, 11), new ItemStack(TFCItems.powder, 1, 7)); // Limonite
																													// -
																													// Yellow
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(TFCItems.dye, 1, 12),
				new ItemStack(TFCItems.powder, 1, 8), new ItemStack(TFCItems.lime, 1, 0), "blockSand")); // Malachite,
																											// Flux
																											// &
																											// Sand
																											// -
		...
		// GameRegistry.addRecipe(new ShapelessOreRecipe(new
		// ItemStack(TFCItems.powder, 2, 0), new ItemStack(TFCItems.looseRock,
		// 1, Global.STONE_FLUXINDEX[i]), "itemHammer"));
		GameRegistry.addRecipe(
				new ShapelessOreRecipe(new ItemStack(TFCItems.powder, 1, 0), new ItemStack(TFCItems.lime, 1, 0)));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(TFCItems.powder, 6, 0),
				new ItemStack(TFCItems.oreChunk, 1, 32), "itemHammer"));

		// Devices
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.anvil, 1, 1), "###", " # ", "###", '#',
				"ingotDoubleCopper"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.anvil, 1, 2), "###", " # ", "###", '#',
				"ingotDoubleBronze"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.anvil, 1, 3), "###", " # ", "###", '#',
				"ingotDoubleWroughtIron"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.anvil, 1, 4), "###", " # ", "###", '#',
				"ingotDoubleSteel"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.anvil, 1, 5), "###", " # ", "###", '#',
				"ingotDoubleBlackSteel"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.anvil, 1, 6), "###", " # ", "###", '#',
				"ingotDoubleBlueSteel"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.anvil, 1, 7), "###", " # ", "###", '#',
				"ingotDoubleRedSteel"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.anvil2, 1, 0), "###", " # ", "###", '#',
				"ingotDoubleRoseGold"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.anvil2, 1, 1), "###", " # ", "###", '#',
				"ingotDoubleBismuthBronze"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.anvil2, 1, 2), "###", " # ", "###", '#',
				"ingotDoubleBlackBronze"));

		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.bloomery, 1), "PPP", "P P", "PPP", 'P',
				"plateDoubleAnyBronze"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.blastFurnace, 1), "PPP", "PCP", "PPP", 'P',
				"plateDoubleWroughtIron", 'C', new ItemStack(TFCBlocks.crucible, 1)));

		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCBlocks.spawnMeter, 1), "PPP", "GKG", "PPP", 'P',
				"stoneSmooth", 'K', "gemChipped", 'G', new ItemStack(Blocks.glass, 1)));
		...
		// Fire Clay
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.clayBall, 1, 1), "PXP", "XCX", "PXP", 'P',
				new ItemStack(TFCItems.powder, 1, 1), 'X', new ItemStack(TFCItems.powder, 1, 2), 'C', "lumpClay"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.clayBall, 1, 1), "PXP", "XCX", "PXP", 'P',
				new ItemStack(TFCItems.powder, 1, 2), 'X', new ItemStack(TFCItems.powder, 1, 1), 'C', "lumpClay"));

		GameRegistry.addRecipe(new ItemStack(TFCItems.fireBrick, 2, 0), "PP", "PP", 'P',
				new ItemStack(TFCItems.clayBall, 1, 1));

		GameRegistry.addRecipe(new ItemStack(TFCBlocks.fireBrick, 2, 0), "PXP", "XPX", "PXP", 'P',
				new ItemStack(TFCItems.fireBrick, 1, 1), 'X', new ItemStack(TFCItems.mortar, 1));
		...
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(Items.gunpowder, 2, 0), "gemCharcoal", "dustSulfur",
				"dustSaltpeter"));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(TFCItems.fertilizer, 2, 0),
				new ItemStack(TFCItems.dye, 1, 15), new ItemStack(TFCItems.powder, 1, 10), "dustSaltpeter"));

		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(Items.item_frame, 1), "###", "#$#", "###", '#',
				"stickWood", '$', "materialLeather"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(Items.painting, 1), "###", "#$#", "###", '#',
				"stickWood", '$', "materialCloth"));

		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(Blocks.carpet, 2, 0), "$$", '$', "materialCloth"));

		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(TFCBlocks.litPumpkin, 1), "blockTorch",
				new ItemStack(TFCItems.pumpkinShell)));
		...
		{
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(Blocks.carpet, 1, i), Global.DYE_NAMES[i],
			...
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(TFCItems.potterySmallVessel, 1, 0),
					new ItemStack(TFCItems.potterySmallVessel, 1, 0), Global.DYE_NAMES[i]));
		}

		GameRegistry.addRecipe(
				new ShapedOreRecipe(new ItemStack(Blocks.rail, 64), "PsP", "PsP", 'P', "ingotIron", 's', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(Blocks.golden_rail, 64), " r ", "PsP", "PsP", 'P',
				"ingotGold", 's', "stickWood", 'r', Items.redstone));
		GameRegistry.addRecipe(
				new ShapedOreRecipe(new ItemStack(Items.minecart, 1), "P P", "PPP", 'P', "plateWroughtIron"));
		// GameRegistry.addShapelessRecipe(new ItemStack(TFCItems.minecartCrate,
		// 1), new Object[] { new ItemStack(TFCBlocks.Chest), new
		// ItemStack(Items.minecart)});
		...
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(Items.book, 1), new ItemStack(Items.paper),
				new ItemStack(Items.paper), new ItemStack(Items.paper), "materialLeather"));
		// GameRegistry.addShapelessRecipe(new
		// ItemStack(TFCItems.writabeBookTFC, 1), new Object[]{new
		...
		GameRegistry.addShapelessRecipe(new ItemStack(TFCItems.blueprint, 1), new ItemStack(TFCItems.ink),
		...
		for (int j = 0; j < Global.STONE_IGIN.length; j++)
		{
			...
			GameRegistry.addRecipe(
					new ShapelessOreRecipe(new ItemStack(TFCItems.stoneBrick, 1, j + Global.STONE_IGIN_START),
							new ItemStack(TFCItems.looseRock, 1, j + Global.STONE_IGIN_START), "itemChisel"));

			// cobble <-> cobble block
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.stoneIgInCobble, 1, j), "PP", "PP", 'P',
					new ItemStack(TFCItems.looseRock, 1, j + Global.STONE_IGIN_START));
			GameRegistry.addShapelessRecipe(new ItemStack(TFCItems.looseRock, 4, j + Global.STONE_IGIN_START),
					new ItemStack(TFCBlocks.stoneIgInCobble, 1, j));

			// walls
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.wallCobbleIgIn, 4, j), "RRR", "RRR", 'R',
					new ItemStack(TFCItems.looseRock, 1, j + Global.STONE_IGIN_START));
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.wallRawIgIn, 3, j), "RRR", "RRR", 'R',
					new ItemStack(TFCBlocks.stoneIgIn, 1, j));
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.wallBrickIgIn, 3, j), "BMB", "MBM", 'B',
					new ItemStack(TFCItems.stoneBrick, 1, j + Global.STONE_IGIN_START), 'M',
					new ItemStack(TFCItems.mortar, 1));
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.wallSmoothIgIn, 3, j), "RRR", "RRR", 'R',
		...
		for (int j = 0; j < Global.STONE_SED.length; j++)
		{
			...
			// cobble <-> cobble block
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.stoneSedCobble, 1, j), "PP", "PP", 'P',
					new ItemStack(TFCItems.looseRock, 1, j + Global.STONE_SED_START));
			GameRegistry.addShapelessRecipe(new ItemStack(TFCItems.looseRock, 4, j + Global.STONE_SED_START),
					new ItemStack(TFCBlocks.stoneSedCobble, 1, j));

			// walls
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.wallCobbleSed, 4, j), "RRR", "RRR", 'R',
					new ItemStack(TFCItems.looseRock, 1, j + Global.STONE_SED_START));
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.wallRawSed, 3, j), "RRR", "RRR", 'R',
					new ItemStack(TFCBlocks.stoneSed, 1, j));
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.wallBrickSed, 3, j), "BMB", "MBM", 'B',
					new ItemStack(TFCItems.stoneBrick, 1, j + Global.STONE_SED_START), 'M',
					new ItemStack(TFCItems.mortar, 1));
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.wallSmoothSed, 3, j), "RRR", "RRR", 'R',
		...
		for (int j = 0; j < Global.STONE_IGEX.length; j++)
		{
			...
			// cobble <-> cobble block
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.stoneIgExCobble, 1, j), "PP", "PP", 'P',
					new ItemStack(TFCItems.looseRock, 1, j + Global.STONE_IGEX_START));
			GameRegistry.addShapelessRecipe(new ItemStack(TFCItems.looseRock, 4, j + Global.STONE_IGEX_START),
					new ItemStack(TFCBlocks.stoneIgExCobble, 1, j));

			// walls
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.wallCobbleIgEx, 4, j), "RRR", "RRR", 'R',
					new ItemStack(TFCItems.looseRock, 1, j + Global.STONE_IGEX_START));
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.wallRawIgEx, 3, j), "RRR", "RRR", 'R',
					new ItemStack(TFCBlocks.stoneIgEx, 1, j));
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.wallBrickIgEx, 3, j), "BMB", "MBM", 'B',
					new ItemStack(TFCItems.stoneBrick, 1, j + Global.STONE_IGEX_START), 'M',
					new ItemStack(TFCItems.mortar, 1));
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.wallSmoothIgEx, 3, j), "RRR", "RRR", 'R',
		...
		for (int j = 0; j < Global.STONE_MM.length; j++)
		{
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.stoneMMBrick, 4, j), "PXP", "XPX", "PXP", 'P',
					...
					new ItemStack(TFCItems.mortar, 1));
			GameRegistry
					.addRecipe(new ShapelessOreRecipe(new ItemStack(TFCItems.stoneBrick, 1, j + Global.STONE_MM_START),
							new ItemStack(TFCItems.looseRock, 1, j + Global.STONE_MM_START), "itemChisel"));

			// cobble <-> cobble block
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.stoneMMCobble, 1, j), "PP", "PP", 'P',
					new ItemStack(TFCItems.looseRock, 1, j + Global.STONE_MM_START));
			GameRegistry.addShapelessRecipe(new ItemStack(TFCItems.looseRock, 4, j + Global.STONE_MM_START),
					new ItemStack(TFCBlocks.stoneMMCobble, 1, j));

			// walls
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.wallCobbleMM, 4, j), "RRR", "RRR", 'R',
					new ItemStack(TFCItems.looseRock, 1, j + Global.STONE_MM_START));
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.wallRawMM, 3, j), "RRR", "RRR", 'R',
					new ItemStack(TFCBlocks.stoneMM, 1, j));
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.wallBrickMM, 3, j), "BMB", "MBM", 'B',
					new ItemStack(TFCItems.stoneBrick, 1, j + Global.STONE_MM_START), 'M',
					new ItemStack(TFCItems.mortar, 1));
			GameRegistry.addRecipe(new ItemStack(TFCBlocks.wallSmoothMM, 3, j), "RRR", "RRR", 'R',
	 ...
	 * if(TFC_ItemHeat.GetTemp(is) > TFC_ItemHeat.IsCookable(is)) return null;
	 * return is; }
	 */
	...
	private static void vanillaRecipes()
	{
		...
		// Otherwise TFC can not use the 4 planks recipe to create its own
		// crafting upgrade.
		...
		// Have to do this by class for some items that are overriden like the
		// bow
		removeRecipe(ItemBow.class);

		// Needs items to be available, but the TFC recipes can't yet be
		// registerd
	...
	private static void registerToolRecipes()
	{
		...
		GameRegistry.addRecipe(new ItemStack(TFCItems.rope, 1), "RR ", "RR ", "  R", 'R',
				new ItemStack(TFCItems.juteFiber, 1));

		GameRegistry.addRecipe(new ItemStack(TFCItems.goldPan, 1, 0), "1", '1',
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.spindleHead, 1, 0), "P", "#", 'P', "lumpClay",
				'#', "stickWood"));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.igInShovel, 1, 0), "1", "2", '1',
				TFCItems.igInStoneShovelHead, '2', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.sedShovel, 1, 0), "1", "2", '1',
				TFCItems.sedStoneShovelHead, '2', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.igExShovel, 1, 0), "1", "2", '1',
				TFCItems.igExStoneShovelHead, '2', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.mMShovel, 1, 0), "1", "2", '1',
				TFCItems.mMStoneShovelHead, '2', "stickWood"));
		// stone axes
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.igInAxe, 1, 0), "1", "2", '1',
				TFCItems.igInStoneAxeHead, '2', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.sedAxe, 1, 0), "1", "2", '1',
				TFCItems.sedStoneAxeHead, '2', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.igExAxe, 1, 0), "1", "2", '1',
				TFCItems.igExStoneAxeHead, '2', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.mMAxe, 1, 0), "1", "2", '1',
				TFCItems.mMStoneAxeHead, '2', "stickWood"));
		// stone hoes
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.igInHoe, 1, 0), "1", "2", '1',
				TFCItems.igInStoneHoeHead, '2', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.sedHoe, 1, 0), "1", "2", '1',
				TFCItems.sedStoneHoeHead, '2', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.igExHoe, 1, 0), "1", "2", '1',
				TFCItems.igExStoneHoeHead, '2', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.mMHoe, 1, 0), "1", "2", '1',
				TFCItems.mMStoneHoeHead, '2', "stickWood"));

		// bone shovels
		GameRegistry.addRecipe(new ItemStack(TFCItems.igInShovel, 1, 0), "1", "2", '1', TFCItems.igInStoneShovelHead,
				'2', new ItemStack(TFCItems.bone));
		GameRegistry.addRecipe(new ItemStack(TFCItems.sedShovel, 1, 0), "1", "2", '1', TFCItems.sedStoneShovelHead, '2',
				new ItemStack(TFCItems.bone));
		GameRegistry.addRecipe(new ItemStack(TFCItems.igExShovel, 1, 0), "1", "2", '1', TFCItems.igExStoneShovelHead,
				'2', new ItemStack(TFCItems.bone));
		GameRegistry.addRecipe(new ItemStack(TFCItems.mMShovel, 1, 0), "1", "2", '1', TFCItems.mMStoneShovelHead, '2',
				new ItemStack(TFCItems.bone));
		// bone axes
		GameRegistry.addRecipe(new ItemStack(TFCItems.igInAxe, 1, 0), "1", "2", '1', TFCItems.igInStoneAxeHead, '2',
				new ItemStack(TFCItems.bone));
		GameRegistry.addRecipe(new ItemStack(TFCItems.sedAxe, 1, 0), "1", "2", '1', TFCItems.sedStoneAxeHead, '2',
				new ItemStack(TFCItems.bone));
		GameRegistry.addRecipe(new ItemStack(TFCItems.igExAxe, 1, 0), "1", "2", '1', TFCItems.igExStoneAxeHead, '2',
				new ItemStack(TFCItems.bone));
		GameRegistry.addRecipe(new ItemStack(TFCItems.mMAxe, 1, 0), "1", "2", '1', TFCItems.mMStoneAxeHead, '2',
				new ItemStack(TFCItems.bone));
		// bone hoes
		GameRegistry.addRecipe(new ItemStack(TFCItems.igInHoe, 1, 0), "1", "2", '1', TFCItems.igInStoneHoeHead, '2',
				new ItemStack(TFCItems.bone));
		GameRegistry.addRecipe(new ItemStack(TFCItems.sedHoe, 1, 0), "1", "2", '1', TFCItems.sedStoneHoeHead, '2',
				new ItemStack(TFCItems.bone));
		GameRegistry.addRecipe(new ItemStack(TFCItems.igExHoe, 1, 0), "1", "2", '1', TFCItems.igExStoneHoeHead, '2',
				new ItemStack(TFCItems.bone));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.stoneHammer, 1, 0), "1", "2", '1',
				TFCItems.stoneHammerHead, '2', new ItemStack(TFCItems.bone)));

		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.stoneKnife, 1, 0), "1", "2", '1',
				TFCItems.stoneKnifeHead, '2', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.stoneKnife, 1, 0), "1", "2", '1',
				TFCItems.stoneKnifeHead, '2', new ItemStack(TFCItems.bone)));
		...
		// trowels
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.trowelBismuthBronze, 1), "T", "S", 'S',
				new ItemStack(TFCItems.bismuthBronzeTrowelHead, 1, 0), 'T', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.trowelBlackBronze, 1), "T", "S", 'S',
				new ItemStack(TFCItems.blackBronzeTrowelHead, 1, 0), 'T', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.trowelBlackSteel, 1), "T", "S", 'S',
				new ItemStack(TFCItems.blackSteelTrowelHead, 1, 0), 'T', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.trowelBlueSteel, 1), "T", "S", 'S',
				new ItemStack(TFCItems.blueSteelTrowelHead, 1, 0), 'T', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.trowelBronze, 1), "T", "S", 'S',
				new ItemStack(TFCItems.bronzeTrowelHead, 1, 0), 'T', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.trowelCopper, 1), "T", "S", 'S',
				new ItemStack(TFCItems.copperTrowelHead, 1, 0), 'T', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.trowelIron, 1), "T", "S", 'S',
				new ItemStack(TFCItems.wroughtIronTrowelHead, 1, 0), 'T', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.trowelRedSteel, 1), "T", "S", 'S',
				new ItemStack(TFCItems.redSteelTrowelHead, 1, 0), 'T', "stickWood"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TFCItems.trowelSteel, 1), "T", "S", 'S',
				new ItemStack(TFCItems.steelTrowelHead, 1, 0), 'T', "stickWood"));
		// Scythes
		...
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayMoldHoe, 1),
				new Object[] { "     ", "#####", "   ##", "     ", '#', new ItemStack(TFCItems.flatClay, 1, 1) });
		...
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayMoldMace, 1), new Object[] { "  #  ",
				" ### ", " ### ", " ### ", "  #  ", '#', new ItemStack(TFCItems.flatClay, 1, 1) });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayMoldTrowel, 1), new Object[] { "  #  ",
				"  #  ", " ### ", " ### ", "  #  ", '#', new ItemStack(TFCItems.flatClay, 1, 1) });
		...
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayMoldScythe, 1), new Object[] { "     ",
				"#### ", " ####", "   ##", "     ", '#', new ItemStack(TFCItems.flatClay, 1, 1) });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayMoldKnife, 1),
				new Object[] { "  # ", " ## ", " ## ", " ## ", " ## ", '#', new ItemStack(TFCItems.flatClay, 1, 1) });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayMoldJavelin, 1), new Object[] { "###  ",
				"#### ", "#####", " ### ", "  #  ", '#', new ItemStack(TFCItems.flatClay, 1, 1) });
		// The mold for sheets of glass or metal

		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayMoldSheet, 1), new Object[] { "     ",
				" ### ", " ### ", " ### ", "     ", '#', new ItemStack(TFCItems.flatClay, 1, 1) });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayBlowpipe, 1), new Object[] { "# # #",
				"# # #", "# # #", "# # #", "# # #", '#', new ItemStack(TFCItems.flatClay, 1, 1) });
		 ...
		 * ItemStack(TFCItems.leatherHelmet, 1), new Object[] { "#####", "#   #"
		 * , "#   #", '#', TFCItems.flatLeather });
		 * CraftingManagerTFC.getInstance().addRecipe(new
		 * ItemStack(TFCItems.leatherChestplate, 1), new Object[] { "#   #",
		 * "#####", "#####", "#####", "#####", '#', TFCItems.flatLeather });
		 * CraftingManagerTFC.getInstance().addRecipe(new
		 * ItemStack(TFCItems.leatherLeggings, 1), new Object[] { "#####",
		 * "#####", "## ##", "## ##", "## ##", '#', TFCItems.flatLeather });
		 * CraftingManagerTFC.getInstance().addRecipe(new
		 * ItemStack(TFCItems.leatherBoots, 1), new Object[] { "##   ", "##   ",
		 * "##   ", "#### ", "#####", '#', TFCItems.flatLeather });
		 */
		...
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.sockCloth, 1, 0),
				new Object[] { "     ", "## ##", "## ##", "## ##", "## ##", '#', TFCItems.flatWool });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.hatPiece, 2, 0),
				new Object[] { "  #  ", " ### ", "     ", "  #  ", " ### ", '#', TFCItems.flatWool });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.shirtBody, 1, 0),
				new Object[] { "#   #", "#####", "#####", "#####", "#####", '#', TFCItems.flatWool });
		CraftingManagerTFC.getInstance().addRecipe(getWool(new ItemStack(TFCItems.pantsPiece, 1, 0)),
				new Object[] { "#####", "#####", "## ##", "## ##", "## ##", '#', TFCItems.flatWool });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.coatBodyFront, 1, 0),
				new Object[] { "#   #", "## ##", "## ##", "## ##", "## ##", '#', TFCItems.flatWool });
		...
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.sockCloth, 1, 1),
				new Object[] { "     ", "## ##", "## ##", "## ##", "## ##", '#', TFCItems.flatSilk });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.hatPiece, 2, 1),
				new Object[] { "  #  ", " ### ", "     ", "  #  ", " ### ", '#', TFCItems.flatSilk });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.shirtBody, 1, 1),
				new Object[] { "#   #", "#####", "#####", "#####", "#####", '#', TFCItems.flatSilk });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.pantsPiece, 1, 1),
				new Object[] { "#####", "#####", "## ##", "## ##", "## ##", '#', TFCItems.flatSilk });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.coatBodyFront, 1, 1),
				new Object[] { "#   #", "## ##", "## ##", "## ##", "## ##", '#', TFCItems.flatSilk });
		...
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.bootSole, 1, 0),
				new Object[] { "     ", "     ", "## ##", "## ##", "## ##", '#', TFCItems.flatLeather });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.shirtSleeves, 1, 2),
				new Object[] { "## ##", "## ##", "## ##", "## ##", "## ##", '#', TFCItems.flatLeather });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.hatPiece, 2, 2),
				new Object[] { "  #  ", " ### ", "     ", "  #  ", " ### ", '#', TFCItems.flatLeather });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.shirtBody, 1, 2),
				new Object[] { "#   #", "#####", "#####", "#####", "#####", '#', TFCItems.flatLeather });
		...
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.sockCloth, 1, 2),
				new Object[] { "     ", "## ##", "## ##", "## ##", "## ##", '#', TFCItems.flatLinen });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.hatPiece, 2, 3),
				new Object[] { "  #  ", " ### ", "     ", "  #  ", " ### ", '#', TFCItems.flatLinen });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.shirtBody, 1, 3),
				new Object[] { "#   #", "#####", "#####", "#####", "#####", '#', TFCItems.flatLinen });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.pantsPiece, 1, 3),
				new Object[] { "#####", "#####", "## ##", "## ##", "## ##", '#', TFCItems.flatLinen });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.coatBodyFront, 1, 2),
				new Object[] { "#   #", "## ##", "## ##", "## ##", "## ##", '#', TFCItems.flatLinen });
		...
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.bootSole, 1, 1),
				new Object[] { "     ", "     ", "## ##", "## ##", "## ##", '#', TFCItems.flatWolfFur });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.shirtSleeves, 1, 4),
				new Object[] { "## ##", "## ##", "## ##", "## ##", "## ##", '#', TFCItems.flatWolfFur });
		...
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.bootSole, 1, 2),
				new Object[] { "     ", "     ", "## ##", "## ##", "## ##", '#', TFCItems.flatBearFur });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.shirtSleeves, 1, 5),
				new Object[] { "## ##", "## ##", "## ##", "## ##", "## ##", '#', TFCItems.flatBearFur });
	...
	private static void registerKnapping()
	{
		...
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.stoneKnifeHead, 2), new Object[] { " # # ",
				"## ##", "## ##", "## ##", "## ##", '#', new ItemStack(TFCItems.flatRock, 1, WILD) });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.stoneKnifeHead, 1),
				new Object[] { " #", "##", "##", "##", "##", '#', new ItemStack(TFCItems.flatRock, 1, WILD) });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.stoneHammerHead, 1),
				new Object[] { "#####", "#####", "  #  ", '#', new ItemStack(TFCItems.flatRock, 1, WILD) });

		for (int i = 0; i < Global.STONE_IGIN.length; i++)
		{
			CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.igInStoneShovelHead, 1),
					new Object[] { "###", "###", "###", "###", " # ", '#',
							new ItemStack(TFCItems.flatRock, 1, i + Global.STONE_IGIN_START) });
			CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.igInStoneAxeHead, 1),
					new Object[] { " #   ", "#### ", "#####", "#### ", " #   ", '#',
							new ItemStack(TFCItems.flatRock, 1, i + Global.STONE_IGIN_START) });
			CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.igInStoneHoeHead, 1), new Object[] {
					"#####", "   ##", '#', new ItemStack(TFCItems.flatRock, 1, i + Global.STONE_IGIN_START) });
			CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.igInStoneJavelinHead, 1),
					new Object[] { "###  ", "#### ", "#####", " ### ", "  #  ", '#',
							new ItemStack(TFCItems.flatRock, 1, i + Global.STONE_IGIN_START) });
		}
		for (int i = 0; i < Global.STONE_SED.length; i++)
		{
			CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.sedStoneShovelHead, 1),
					new Object[] { "###", "###", "###", "###", " # ", '#',
							new ItemStack(TFCItems.flatRock, 1, i + Global.STONE_SED_START) });
			CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.sedStoneAxeHead, 1),
					new Object[] { " #   ", "#### ", "#####", "#### ", " #   ", '#',
							new ItemStack(TFCItems.flatRock, 1, i + Global.STONE_SED_START) });
			CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.sedStoneHoeHead, 1), new Object[] {
					"#####", "   ##", '#', new ItemStack(TFCItems.flatRock, 1, i + Global.STONE_SED_START) });
			CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.sedStoneJavelinHead, 1),
					new Object[] { "###  ", "#### ", "#####", " ### ", "  #  ", '#',
							new ItemStack(TFCItems.flatRock, 1, i + Global.STONE_SED_START) });
		}
		for (int i = 0; i < Global.STONE_IGEX.length; i++)
		{
			CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.igExStoneShovelHead, 1),
					new Object[] { "###", "###", "###", "###", " # ", '#',
							new ItemStack(TFCItems.flatRock, 1, i + Global.STONE_IGEX_START) });
			CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.igExStoneAxeHead, 1),
					new Object[] { " #   ", "#### ", "#####", "#### ", " #   ", '#',
							new ItemStack(TFCItems.flatRock, 1, i + Global.STONE_IGEX_START) });
			CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.igExStoneHoeHead, 1), new Object[] {
					"#####", "   ##", '#', new ItemStack(TFCItems.flatRock, 1, i + Global.STONE_IGEX_START) });
			CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.igExStoneJavelinHead, 1),
					new Object[] { "###  ", "#### ", "#####", " ### ", "  #  ", '#',
							new ItemStack(TFCItems.flatRock, 1, i + Global.STONE_IGEX_START) });
		}
		for (int i = 0; i < Global.STONE_MM.length; i++)
		{
			CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.mMStoneShovelHead, 1),
					new Object[] { "###", "###", "###", "###", " # ", '#',
							new ItemStack(TFCItems.flatRock, 1, i + Global.STONE_MM_START) });
			CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.mMStoneAxeHead, 1),
					new Object[] { " #   ", "#### ", "#####", "#### ", " #   ", '#',
							new ItemStack(TFCItems.flatRock, 1, i + Global.STONE_MM_START) });
			CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.mMStoneHoeHead, 1), new Object[] {
					"#####", "   ##", '#', new ItemStack(TFCItems.flatRock, 1, i + Global.STONE_MM_START) });
			CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.mMStoneJavelinHead, 1),
					new Object[] { "###  ", "#### ", "#####", " ### ", "  #  ", '#',
							new ItemStack(TFCItems.flatRock, 1, i + Global.STONE_MM_START) });
		}

		// Inverse Clay Knapping
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.ceramicMold, 2, 0),
				new Object[] { "    ", " ## ", " ## ", " ## ", "    ", '#', new ItemStack(TFCItems.flatClay, 1, 1) });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.potteryJug, 1, 0), new Object[] { "X XXX",
				"    X", "   X ", "    X", "   XX", 'X', new ItemStack(TFCItems.flatClay, 1, 1) });
		 ...
		 * ItemStack(TFCItems.potteryBowl, 2), new Object[] { "#####", "#####",
	...
	private static void registerAlloys()
	{
		...
		CraftingManagerTFC.getInstance()
				.addShapelessRecipe(new ItemStack(TFCItems.weakRedSteelUnshaped, 4),
						new Object[] { new ItemStack(TFCItems.blackSteelUnshaped),
								new ItemStack(TFCItems.roseGoldUnshaped), new ItemStack(TFCItems.brassUnshaped),
								new ItemStack(TFCItems.steelUnshaped) });
	...
	private static void registerToolMolds()
	{
		...
		// Mold pouring
		////////////////////////////////////////////////////////////////
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayMoldSheet, 1, 2),
				new Object[] { "12", '1', getStackTemp(new ItemStack(TFCItems.copperUnshaped, 1, 1)), '2',
						new ItemStack(TFCItems.clayMoldSheet, 1, 1) });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayMoldSheet, 1, 3),
				new Object[] { "12", '1', getStackTemp(new ItemStack(TFCItems.bronzeUnshaped, 1, 1)), '2',
						new ItemStack(TFCItems.clayMoldSheet, 1, 1) });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayMoldSheet, 1, 4),
				new Object[] { "12", '1', getStackTemp(new ItemStack(TFCItems.bismuthBronzeUnshaped, 1, 1)), '2',
						new ItemStack(TFCItems.clayMoldSheet, 1, 1) });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayMoldSheet, 1, 5),
				new Object[] { "12", '1', getStackTemp(new ItemStack(TFCItems.blackBronzeUnshaped, 1, 1)), '2',
						new ItemStack(TFCItems.clayMoldSheet, 1, 1) });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayMoldSheet, 1, 6),
				new Object[] { "12", '1', getStackTemp(new ItemStack(TFCItems.moltenGlass, 1, 1)), '2',
						new ItemStack(TFCItems.clayMoldSheet, 1, 1) });

		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayBlowpipe, 1, 2),
				new Object[] { "12", '1', getStackTemp(new ItemStack(TFCItems.moltenGlass, 1, 1)), '2',
						new ItemStack(TFCItems.clayBlowpipe, 1, 1) });
		...
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayMoldTrowel, 1, 2),
				new Object[] { "12", '1', getStackTemp(new ItemStack(TFCItems.copperUnshaped, 1, 1)), '2',
						new ItemStack(TFCItems.clayMoldTrowel, 1, 1) });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayMoldTrowel, 1, 3),
				new Object[] { "12", '1', getStackTemp(new ItemStack(TFCItems.bronzeUnshaped, 1, 1)), '2',
						new ItemStack(TFCItems.clayMoldTrowel, 1, 1) });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayMoldTrowel, 1, 4),
				new Object[] { "12", '1', getStackTemp(new ItemStack(TFCItems.bismuthBronzeUnshaped, 1, 1)), '2',
						new ItemStack(TFCItems.clayMoldTrowel, 1, 1) });
		CraftingManagerTFC.getInstance().addRecipe(new ItemStack(TFCItems.clayMoldTrowel, 1, 5),
				new Object[] { "12", '1', getStackTemp(new ItemStack(TFCItems.blackBronzeUnshaped, 1, 1)), '2',
						new ItemStack(TFCItems.clayMoldTrowel, 1, 1) });
		...
		GameRegistry.addShapelessRecipe(new ItemStack(TFCItems.copperTrowelHead),
				getStackNoTemp(new ItemStack(TFCItems.clayMoldTrowel, 1, 2)));
		GameRegistry.addShapelessRecipe(new ItemStack(TFCItems.bronzeTrowelHead),
				getStackNoTemp(new ItemStack(TFCItems.clayMoldTrowel, 1, 3)));
		GameRegistry.addShapelessRecipe(new ItemStack(TFCItems.bismuthBronzeTrowelHead),
				getStackNoTemp(new ItemStack(TFCItems.clayMoldTrowel, 1, 4)));
		GameRegistry.addShapelessRecipe(new ItemStack(TFCItems.blackBronzeTrowelHead),
				getStackNoTemp(new ItemStack(TFCItems.clayMoldTrowel, 1, 5)));
	...
	public static ItemStack getWool(ItemStack is)
	{
		...
		woolen.setString("material", "wool");
		is.stackTagCompound = woolen;
		return is;
	}

	public static ItemStack getNeedleStringed(ItemStack is)
	{
		NBTTagCompound stringed = new NBTTagCompound();
		stringed.setBoolean("stringed", true);
		is.setTagCompound(stringed);
		return is;
	}

	public static ItemStack getNeedleUnstringed(ItemStack is)
	{
		NBTTagCompound stringed = new NBTTagCompound();
		stringed.setBoolean("stringed", false);
		is.setTagCompound(stringed);
		return is;
	}
	...
	public static void registerAnvilRecipes(Random r, World world)
	{
		...
		// We need to set the world ref so that all anvil recipes can generate
		// correctly
		...
		manager.addPlan("shears", new PlanRecipe(
				new RuleEnum[] { RuleEnum.HITLAST, RuleEnum.HITSECONDFROMLAST, RuleEnum.HITTHIRDFROMLAST }));
		manager.addPlan("oillamp", new PlanRecipe(
				new RuleEnum[] { RuleEnum.BENDLAST, RuleEnum.BENDSECONDFROMLAST, RuleEnum.DRAWTHIRDFROMLAST }));
		manager.addPlan("hopper", new PlanRecipe(
		 ...
		 */
		// Ingots
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.pigIronIngot), null, "ingot", false,
				AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.highCarbonSteelIngot)).clearRecipeSkills());

		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.highCarbonBlackSteelIngot), null, "ingot", false,
				AnvilReq.STEEL, new ItemStack(TFCItems.blackSteelIngot)).clearRecipeSkills());
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.highCarbonBlueSteelIngot), null, "ingot", false,
				AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.blueSteelIngot)).clearRecipeSkills());
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.highCarbonRedSteelIngot), null, "ingot", false,
				AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.redSteelIngot)).clearRecipeSkills());
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.highCarbonSteelIngot), null, "ingot", false,
				AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.steelIngot)).clearRecipeSkills());
		...
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot2x), null, "sheet", false,
				AnvilReq.BISMUTHBRONZE, new ItemStack(TFCItems.bismuthBronzeSheet)));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackBronzeIngot2x), null, "sheet", false,
				AnvilReq.BLACKBRONZE, new ItemStack(TFCItems.blackBronzeSheet)));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelIngot2x), null, "sheet", false,
				AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.blackSteelSheet)));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blueSteelIngot2x), null, "sheet", false,
				AnvilReq.BLUESTEEL, new ItemStack(TFCItems.blueSteelSheet)));
		...
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronIngot2x), null, "sheet", false,
				AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.wroughtIronSheet)));
		...
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.nickelIngot2x), null, "sheet", false,
				AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.nickelSheet)));
		...
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.platinumIngot2x), null, "sheet", false,
				AnvilReq.BRONZE, new ItemStack(TFCItems.platinumSheet)));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.redSteelIngot2x), null, "sheet", false,
				AnvilReq.REDSTEEL, new ItemStack(TFCItems.redSteelSheet)));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.roseGoldIngot2x), null, "sheet", false,
				AnvilReq.BRONZE, new ItemStack(TFCItems.roseGoldSheet)));
		...
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.sterlingSilverIngot2x), null, "sheet", false,
				AnvilReq.BRONZE, new ItemStack(TFCItems.sterlingSilverSheet)));
		...
		// Picks
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot), null, "pickaxe", AnvilReq.BISMUTHBRONZE,
						new ItemStack(TFCItems.bismuthBronzePickaxeHead, 1)).addRecipeSkill(Global.SKILL_TOOLSMITH));
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.blackBronzeIngot), null, "pickaxe", AnvilReq.BLACKBRONZE,
		...
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.wroughtIronIngot), null, "pickaxe", AnvilReq.WROUGHTIRON,
		...
		// shovels
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot), null, "shovel", AnvilReq.BISMUTHBRONZE,
						new ItemStack(TFCItems.bismuthBronzeShovelHead, 1)).addRecipeSkill(Global.SKILL_TOOLSMITH));
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.blackBronzeIngot), null, "shovel", AnvilReq.BLACKBRONZE,
		...
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.wroughtIronIngot), null, "shovel", AnvilReq.WROUGHTIRON,
		...
		// axes
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot), null, "axe", AnvilReq.BISMUTHBRONZE,
		...
		// hoes
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot), null, "hoe", AnvilReq.BISMUTHBRONZE,
		...
		// Hammers
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot), null, "hammer", AnvilReq.BISMUTHBRONZE,
						new ItemStack(TFCItems.bismuthBronzeHammerHead, 1)).addRecipeSkill(Global.SKILL_TOOLSMITH));
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.blackBronzeIngot), null, "hammer", AnvilReq.BLACKBRONZE,
		...
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.wroughtIronIngot), null, "hammer", AnvilReq.WROUGHTIRON,
		...
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.blackBronzeIngot), null, "chisel", AnvilReq.BLACKBRONZE,
		...
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.wroughtIronIngot), null, "chisel", AnvilReq.WROUGHTIRON,
		...
		// ProPicks
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot), null, "propick", AnvilReq.BISMUTHBRONZE,
						new ItemStack(TFCItems.bismuthBronzeProPickHead, 1)).addRecipeSkill(Global.SKILL_TOOLSMITH));
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.blackBronzeIngot), null, "propick", AnvilReq.BLACKBRONZE,
		...
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.wroughtIronIngot), null, "propick", AnvilReq.WROUGHTIRON,
		...
		// Trowels
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot), null, "trowel", AnvilReq.BISMUTHBRONZE,
						new ItemStack(TFCItems.bismuthBronzeTrowelHead, 1)).addRecipeSkill(Global.SKILL_TOOLSMITH));
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.blackBronzeIngot), null, "trowel", AnvilReq.BLACKBRONZE,
						new ItemStack(TFCItems.blackBronzeTrowelHead, 1)).addRecipeSkill(Global.SKILL_TOOLSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelIngot), null, "trowel", AnvilReq.BLACKSTEEL,
				new ItemStack(TFCItems.blackSteelTrowelHead, 1)).addRecipeSkill(Global.SKILL_TOOLSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blueSteelIngot), null, "trowel", AnvilReq.BLUESTEEL,
				new ItemStack(TFCItems.blueSteelTrowelHead, 1)).addRecipeSkill(Global.SKILL_TOOLSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bronzeIngot), null, "trowel", AnvilReq.BRONZE,
				new ItemStack(TFCItems.bronzeTrowelHead, 1)).addRecipeSkill(Global.SKILL_TOOLSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.copperIngot), null, "trowel", AnvilReq.COPPER,
				new ItemStack(TFCItems.copperTrowelHead, 1)).addRecipeSkill(Global.SKILL_TOOLSMITH));
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.wroughtIronIngot), null, "trowel", AnvilReq.WROUGHTIRON,
						new ItemStack(TFCItems.wroughtIronTrowelHead, 1)).addRecipeSkill(Global.SKILL_TOOLSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.redSteelIngot), null, "trowel", AnvilReq.REDSTEEL,
				new ItemStack(TFCItems.redSteelTrowelHead, 1)).addRecipeSkill(Global.SKILL_TOOLSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.steelIngot), null, "trowel", AnvilReq.STEEL,
				new ItemStack(TFCItems.steelTrowelHead, 1)).addRecipeSkill(Global.SKILL_TOOLSMITH));

		// Saws
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot), null, "saw", AnvilReq.BISMUTHBRONZE,
		...
		// Swords
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot2x), null, "sword", AnvilReq.BISMUTHBRONZE,
						new ItemStack(TFCItems.bismuthBronzeSwordHead, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.blackBronzeIngot2x), null, "sword", AnvilReq.BLACKBRONZE,
		...
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.wroughtIronIngot2x), null, "sword", AnvilReq.WROUGHTIRON,
		...
		// Maces
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot2x), null, "mace", AnvilReq.BISMUTHBRONZE,
						new ItemStack(TFCItems.bismuthBronzeMaceHead, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.blackBronzeIngot2x), null, "mace", AnvilReq.BLACKBRONZE,
		...
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.wroughtIronIngot2x), null, "mace", AnvilReq.WROUGHTIRON,
		...
		// Scythes
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot), null, "scythe", AnvilReq.BISMUTHBRONZE,
						new ItemStack(TFCItems.bismuthBronzeScytheHead, 1)).addRecipeSkill(Global.SKILL_TOOLSMITH));
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.blackBronzeIngot), null, "scythe", AnvilReq.BLACKBRONZE,
						new ItemStack(TFCItems.blackBronzeScytheHead, 1)).addRecipeSkill(Global.SKILL_TOOLSMITH));
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.blackSteelIngot), null, "scythe", false, AnvilReq.BLACKSTEEL,
		...
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.wroughtIronIngot), null, "scythe", AnvilReq.WROUGHTIRON,
		...
		// Knifes
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot), null, "knife",
				AnvilReq.BISMUTHBRONZE, new ItemStack(TFCItems.bismuthBronzeKnifeHead, 1))
						.addRecipeSkill(Global.SKILL_WEAPONSMITH).setCraftingBound(40));
		...
		// javelin heads
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot), null, "javelin", AnvilReq.BISMUTHBRONZE,
						new ItemStack(TFCItems.bismuthBronzeJavelinHead, 1)).addRecipeSkill(Global.SKILL_WEAPONSMITH));
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.blackBronzeIngot), null, "javelin", AnvilReq.BLACKBRONZE,
		...
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.wroughtIronIngot), null, "javelin", AnvilReq.WROUGHTIRON,
		...
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeSheet), null, "helmPlate",
				AnvilReq.BISMUTHBRONZE, new ItemStack(TFCItems.bismuthBronzeUnfinishedHelmet, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackBronzeSheet), null, "helmPlate",
				AnvilReq.BLACKBRONZE, new ItemStack(TFCItems.blackBronzeUnfinishedHelmet, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelSheet), null, "helmPlate",
				AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.blackSteelUnfinishedHelmet, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		...
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronSheet), null, "helmPlate",
				AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.wroughtIronUnfinishedHelmet, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		...
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeUnfinishedHelmet, 1, 1), null,
				"helmPlate", AnvilReq.BISMUTHBRONZE, new ItemStack(TFCItems.bismuthBronzeHelmet, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(2));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackBronzeUnfinishedHelmet, 1, 1), null, "helmPlate",
				AnvilReq.BLACKBRONZE, new ItemStack(TFCItems.blackBronzeHelmet, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(2));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelUnfinishedHelmet, 1, 1), null, "helmPlate",
				AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.blackSteelHelmet, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(2));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blueSteelUnfinishedHelmet, 1, 1), null, "helmPlate",
				AnvilReq.BLUESTEEL, new ItemStack(TFCItems.blueSteelHelmet, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(2));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bronzeUnfinishedHelmet, 1, 1), null, "helmPlate",
				AnvilReq.BRONZE, new ItemStack(TFCItems.bronzeHelmet, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(2));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.copperUnfinishedHelmet, 1, 1), null, "helmPlate",
				AnvilReq.COPPER, new ItemStack(TFCItems.copperHelmet, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(2));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronUnfinishedHelmet, 1, 1), null, "helmPlate",
				AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.wroughtIronHelmet, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(2));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.redSteelUnfinishedHelmet, 1, 1), null, "helmPlate",
				AnvilReq.REDSTEEL, new ItemStack(TFCItems.redSteelHelmet, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(2));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.steelUnfinishedHelmet, 1, 1), null, "helmPlate",
				AnvilReq.STEEL, new ItemStack(TFCItems.steelHelmet, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(2));

		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeSheet2x), null, "chestPlate",
				AnvilReq.BISMUTHBRONZE, new ItemStack(TFCItems.bismuthBronzeUnfinishedChestplate, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackBronzeSheet2x), null, "chestPlate",
				AnvilReq.BLACKBRONZE, new ItemStack(TFCItems.blackBronzeUnfinishedChestplate, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelSheet2x), null, "chestPlate",
				AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.blackSteelUnfinishedChestplate, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blueSteelSheet2x), null, "chestPlate",
				AnvilReq.BLUESTEEL, new ItemStack(TFCItems.blueSteelUnfinishedChestplate, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		...
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronSheet2x), null, "chestPlate",
				AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.wroughtIronUnfinishedChestplate, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.redSteelSheet2x), null, "chestPlate",
				AnvilReq.REDSTEEL, new ItemStack(TFCItems.redSteelUnfinishedChestplate, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		...
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeUnfinishedChestplate, 1, 1), null,
				"chestPlate", AnvilReq.BISMUTHBRONZE, new ItemStack(TFCItems.bismuthBronzeChestplate, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(3));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackBronzeUnfinishedChestplate, 1, 1), null,
				"chestPlate", AnvilReq.BLACKBRONZE, new ItemStack(TFCItems.blackBronzeChestplate, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(3));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelUnfinishedChestplate, 1, 1), null,
				"chestPlate", AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.blackSteelChestplate, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(3));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blueSteelUnfinishedChestplate, 1, 1), null,
				"chestPlate", AnvilReq.BLUESTEEL, new ItemStack(TFCItems.blueSteelChestplate, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(3));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bronzeUnfinishedChestplate, 1, 1), null, "chestPlate",
				AnvilReq.BRONZE, new ItemStack(TFCItems.bronzeChestplate, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(3));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.copperUnfinishedChestplate, 1, 1), null, "chestPlate",
				AnvilReq.COPPER, new ItemStack(TFCItems.copperChestplate, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(3));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronUnfinishedChestplate, 1, 1), null,
				"chestPlate", AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.wroughtIronChestplate, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(3));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.redSteelUnfinishedChestplate, 1, 1), null,
				"chestPlate", AnvilReq.REDSTEEL, new ItemStack(TFCItems.redSteelChestplate, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(3));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.steelUnfinishedChestplate, 1, 1), null, "chestPlate",
				AnvilReq.STEEL, new ItemStack(TFCItems.steelChestplate, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(3));

		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeSheet2x), null, "legsPlate",
				AnvilReq.BISMUTHBRONZE, new ItemStack(TFCItems.bismuthBronzeUnfinishedGreaves, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackBronzeSheet2x), null, "legsPlate",
				AnvilReq.BLACKBRONZE, new ItemStack(TFCItems.blackBronzeUnfinishedGreaves, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelSheet2x), null, "legsPlate",
				AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.blackSteelUnfinishedGreaves, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blueSteelSheet2x), null, "legsPlate",
				AnvilReq.BLUESTEEL, new ItemStack(TFCItems.blueSteelUnfinishedGreaves, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		...
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronSheet2x), null, "legsPlate",
				AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.wroughtIronUnfinishedGreaves, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		...
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeUnfinishedGreaves, 1, 1), null,
				"legsPlate", AnvilReq.BISMUTHBRONZE, new ItemStack(TFCItems.bismuthBronzeGreaves, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(3));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackBronzeUnfinishedGreaves, 1, 1), null, "legsPlate",
				AnvilReq.BLACKBRONZE, new ItemStack(TFCItems.blackBronzeGreaves, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(3));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelUnfinishedGreaves, 1, 1), null, "legsPlate",
				AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.blackSteelGreaves, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(3));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blueSteelUnfinishedGreaves, 1, 1), null, "legsPlate",
				AnvilReq.BLUESTEEL, new ItemStack(TFCItems.blueSteelGreaves, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(3));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bronzeUnfinishedGreaves, 1, 1), null, "legsPlate",
				AnvilReq.BRONZE, new ItemStack(TFCItems.bronzeGreaves, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(3));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.copperUnfinishedGreaves, 1, 1), null, "legsPlate",
				AnvilReq.COPPER, new ItemStack(TFCItems.copperGreaves, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(3));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronUnfinishedGreaves, 1, 1), null, "legsPlate",
				AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.wroughtIronGreaves, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(3));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.redSteelUnfinishedGreaves, 1, 1), null, "legsPlate",
				AnvilReq.REDSTEEL, new ItemStack(TFCItems.redSteelGreaves, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(3));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.steelUnfinishedGreaves, 1, 1), null, "legsPlate",
				AnvilReq.STEEL, new ItemStack(TFCItems.steelGreaves, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(3));

		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeSheet), null, "bootsplate",
				AnvilReq.BISMUTHBRONZE, new ItemStack(TFCItems.bismuthBronzeUnfinishedBoots, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackBronzeSheet), null, "bootsplate",
				AnvilReq.BLACKBRONZE, new ItemStack(TFCItems.blackBronzeUnfinishedBoots, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelSheet), null, "bootsplate",
				AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.blackSteelUnfinishedBoots, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blueSteelSheet), null, "bootsplate",
				AnvilReq.BLUESTEEL, new ItemStack(TFCItems.blueSteelUnfinishedBoots, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		...
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronSheet), null, "bootsplate",
				AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.wroughtIronUnfinishedBoots, 1, 0))
						.addRecipeSkill(Global.SKILL_ARMORSMITH));
		...
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeUnfinishedBoots, 1, 1), null,
				"bootsplate", AnvilReq.BISMUTHBRONZE, new ItemStack(TFCItems.bismuthBronzeBoots, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(2));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackBronzeUnfinishedBoots, 1, 1), null, "bootsplate",
				AnvilReq.BLACKBRONZE, new ItemStack(TFCItems.blackBronzeBoots, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(2));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelUnfinishedBoots, 1, 1), null, "bootsplate",
				AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.blackSteelBoots, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(2));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blueSteelUnfinishedBoots, 1, 1), null, "bootsplate",
				AnvilReq.BLUESTEEL, new ItemStack(TFCItems.blueSteelBoots, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(2));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.bronzeUnfinishedBoots, 1, 1), null, "bootsplate",
				AnvilReq.BRONZE, new ItemStack(TFCItems.bronzeBoots, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(2));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.copperUnfinishedBoots, 1, 1), null, "bootsplate",
				AnvilReq.COPPER, new ItemStack(TFCItems.copperBoots, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(2));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronUnfinishedBoots, 1, 1), null, "bootsplate",
				AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.wroughtIronBoots, 1))
						.addRecipeSkill(Global.SKILL_ARMORSMITH).setCraftingXP(2));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.redSteelUnfinishedBoots, 1, 1), null, "bootsplate",
				AnvilReq.REDSTEEL, new ItemStack(TFCItems.redSteelBoots, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(2));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.steelUnfinishedBoots, 1, 1), null, "bootsplate",
				AnvilReq.STEEL, new ItemStack(TFCItems.steelBoots, 1)).addRecipeSkill(Global.SKILL_ARMORSMITH)
						.setCraftingXP(2));
		...
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.rawBloom, 1, WILD), null, "refinebloom",
				AnvilReq.BRONZE, new ItemStack(TFCItems.bloom, 1)).setInheritsDamage().clearRecipeSkills());
		...
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronSheet2x), null, "tuyere",
				AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.tuyereWroughtIron, 1)));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.steelSheet2x), null, "tuyere", AnvilReq.STEEL,
				new ItemStack(TFCItems.tuyereSteel, 1)));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelSheet2x), null, "tuyere",
				AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.tuyereBlackSteel, 1)));
		...
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.wroughtIronIngot2x), new ItemStack(TFCItems.wroughtIronIngot2x),
						"grill", AnvilReq.WROUGHTIRON, new ItemStack(TFCBlocks.grill, 1, 0)));
		manager.addRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronKnifeHead),
				new ItemStack(TFCItems.wroughtIronKnifeHead), "shears", AnvilReq.WROUGHTIRON,
		...
		manager.addRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.wroughtIronSheet2x), new ItemStack(TFCItems.wroughtIronSheet2x),
						"hopper", AnvilReq.WROUGHTIRON, new ItemStack(TFCBlocks.hopper, 1, 0)));
	}

	private static void addTrapDoor(Item sheet, int index)
	{
		AnvilManager manager = AnvilManager.getInstance();
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.bismuthIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index)));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.bismuthBronzeIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (1 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.blackBronzeIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (2 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.blackSteelIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (3 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.blueSteelIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (4 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.brassIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (5 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.bronzeIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (6 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.copperIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (7 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.goldIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (8 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.wroughtIronIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (9 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.leadIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (10 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.nickelIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (11 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.platinumIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (13 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.redSteelIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (14 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.roseGoldIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (15 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.silverIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (16 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.steelIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (17 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.sterlingSilverIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (18 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.tinIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (19 << 5))));
		manager.addRecipe(new AnvilRecipe(new ItemStack(sheet), new ItemStack(TFCItems.zincIngot), "trapdoor",
				AnvilReq.COPPER, new ItemStack(TFCBlocks.metalTrapDoor, 1, index + (20 << 5))));
	}
	...
	private static void addWeldRecipes(AnvilManager manager)
	{
		 ...
		 * Weld Recipes
		 */
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthIngot),
				new ItemStack(TFCItems.bismuthIngot), AnvilReq.STONE, new ItemStack(TFCItems.bismuthIngot2x, 1)));
		manager.addWeldRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeIngot), new ItemStack(TFCItems.bismuthBronzeIngot),
						AnvilReq.COPPER, new ItemStack(TFCItems.bismuthBronzeIngot2x, 1)));
		manager.addWeldRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.blackBronzeIngot), new ItemStack(TFCItems.blackBronzeIngot),
						AnvilReq.COPPER, new ItemStack(TFCItems.blackBronzeIngot2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelIngot),
				new ItemStack(TFCItems.blackSteelIngot), AnvilReq.STEEL, new ItemStack(TFCItems.blackSteelIngot2x, 1)));
		manager.addWeldRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.blueSteelIngot), new ItemStack(TFCItems.blueSteelIngot),
						AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.blueSteelIngot2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.brassIngot), new ItemStack(TFCItems.brassIngot),
				AnvilReq.COPPER, new ItemStack(TFCItems.brassIngot2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.bronzeIngot), new ItemStack(TFCItems.bronzeIngot),
				AnvilReq.COPPER, new ItemStack(TFCItems.bronzeIngot2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.copperIngot), new ItemStack(TFCItems.copperIngot),
				AnvilReq.STONE, new ItemStack(TFCItems.copperIngot2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.goldIngot), new ItemStack(TFCItems.goldIngot),
				AnvilReq.COPPER, new ItemStack(TFCItems.goldIngot2x, 1)));
		manager.addWeldRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.wroughtIronIngot), new ItemStack(TFCItems.wroughtIronIngot),
						AnvilReq.BRONZE, new ItemStack(TFCItems.wroughtIronIngot2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.leadIngot), new ItemStack(TFCItems.leadIngot),
				AnvilReq.COPPER, new ItemStack(TFCItems.leadIngot2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.nickelIngot), new ItemStack(TFCItems.nickelIngot),
				AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.nickelIngot2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.pigIronIngot),
				new ItemStack(TFCItems.pigIronIngot), AnvilReq.BRONZE, new ItemStack(TFCItems.pigIronIngot2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.platinumIngot),
				new ItemStack(TFCItems.platinumIngot), AnvilReq.BRONZE, new ItemStack(TFCItems.platinumIngot2x, 1)));
		manager.addWeldRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.redSteelIngot), new ItemStack(TFCItems.redSteelIngot),
						AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.redSteelIngot2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.roseGoldIngot),
				new ItemStack(TFCItems.roseGoldIngot), AnvilReq.COPPER, new ItemStack(TFCItems.roseGoldIngot2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.silverIngot), new ItemStack(TFCItems.silverIngot),
				AnvilReq.COPPER, new ItemStack(TFCItems.silverIngot2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.steelIngot), new ItemStack(TFCItems.steelIngot),
				AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.steelIngot2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.sterlingSilverIngot),
				new ItemStack(TFCItems.sterlingSilverIngot), AnvilReq.BRONZE,
				new ItemStack(TFCItems.sterlingSilverIngot2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.tinIngot), new ItemStack(TFCItems.tinIngot),
				AnvilReq.STONE, new ItemStack(TFCItems.tinIngot2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.zincIngot), new ItemStack(TFCItems.zincIngot),
				AnvilReq.STONE, new ItemStack(TFCItems.zincIngot2x, 1)));
		manager.addWeldRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.weakSteelIngot), new ItemStack(TFCItems.pigIronIngot),
						AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.highCarbonBlackSteelIngot, 1)));
		manager.addWeldRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.weakBlueSteelIngot), new ItemStack(TFCItems.blackSteelIngot),
						AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.highCarbonBlueSteelIngot, 1)));
		manager.addWeldRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.weakRedSteelIngot), new ItemStack(TFCItems.blackSteelIngot),
						AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.highCarbonRedSteelIngot, 1)));

		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthSheet),
				new ItemStack(TFCItems.bismuthSheet), AnvilReq.STONE, new ItemStack(TFCItems.bismuthSheet2x, 1)));
		manager.addWeldRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeSheet), new ItemStack(TFCItems.bismuthBronzeSheet),
						AnvilReq.COPPER, new ItemStack(TFCItems.bismuthBronzeSheet2x, 1)));
		manager.addWeldRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.blackBronzeSheet), new ItemStack(TFCItems.blackBronzeSheet),
						AnvilReq.COPPER, new ItemStack(TFCItems.blackBronzeSheet2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelSheet),
				new ItemStack(TFCItems.blackSteelSheet), AnvilReq.STEEL, new ItemStack(TFCItems.blackSteelSheet2x, 1)));
		manager.addWeldRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.blueSteelSheet), new ItemStack(TFCItems.blueSteelSheet),
						AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.blueSteelSheet2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.brassSheet), new ItemStack(TFCItems.brassSheet),
				AnvilReq.COPPER, new ItemStack(TFCItems.brassSheet2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.bronzeSheet), new ItemStack(TFCItems.bronzeSheet),
				AnvilReq.COPPER, new ItemStack(TFCItems.bronzeSheet2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.copperSheet), new ItemStack(TFCItems.copperSheet),
				AnvilReq.STONE, new ItemStack(TFCItems.copperSheet2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.goldSheet), new ItemStack(TFCItems.goldSheet),
				AnvilReq.COPPER, new ItemStack(TFCItems.goldSheet2x, 1)));
		manager.addWeldRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.wroughtIronSheet), new ItemStack(TFCItems.wroughtIronSheet),
						AnvilReq.BRONZE, new ItemStack(TFCItems.wroughtIronSheet2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.leadSheet), new ItemStack(TFCItems.leadSheet),
				AnvilReq.COPPER, new ItemStack(TFCItems.leadSheet2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.nickelSheet), new ItemStack(TFCItems.nickelSheet),
				AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.nickelSheet2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.pigIronSheet),
				new ItemStack(TFCItems.pigIronSheet), AnvilReq.BRONZE, new ItemStack(TFCItems.pigIronSheet2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.platinumSheet),
				new ItemStack(TFCItems.platinumSheet), AnvilReq.BRONZE, new ItemStack(TFCItems.platinumSheet2x, 1)));
		manager.addWeldRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.redSteelSheet), new ItemStack(TFCItems.redSteelSheet),
						AnvilReq.BLACKSTEEL, new ItemStack(TFCItems.redSteelSheet2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.roseGoldSheet),
				new ItemStack(TFCItems.roseGoldSheet), AnvilReq.COPPER, new ItemStack(TFCItems.roseGoldSheet2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.silverSheet), new ItemStack(TFCItems.silverSheet),
				AnvilReq.COPPER, new ItemStack(TFCItems.silverSheet2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.steelSheet), new ItemStack(TFCItems.steelSheet),
				AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.steelSheet2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.sterlingSilverSheet),
				new ItemStack(TFCItems.sterlingSilverSheet), AnvilReq.BRONZE,
				new ItemStack(TFCItems.sterlingSilverSheet2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.tinSheet), new ItemStack(TFCItems.tinSheet),
				AnvilReq.STONE, new ItemStack(TFCItems.tinSheet2x, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.zincSheet), new ItemStack(TFCItems.zincSheet),
				AnvilReq.STONE, new ItemStack(TFCItems.zincSheet2x, 1)));

		// chest
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeUnfinishedChestplate, 1, 0),
				new ItemStack(TFCItems.bismuthBronzeSheet2x), true, AnvilReq.COPPER,
				new ItemStack(TFCItems.bismuthBronzeUnfinishedChestplate, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackBronzeUnfinishedChestplate, 1, 0),
				new ItemStack(TFCItems.blackBronzeSheet2x), true, AnvilReq.COPPER,
				new ItemStack(TFCItems.blackBronzeUnfinishedChestplate, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelUnfinishedChestplate, 1, 0),
				new ItemStack(TFCItems.blackSteelSheet2x), true, AnvilReq.STEEL,
				new ItemStack(TFCItems.blackSteelUnfinishedChestplate, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.blueSteelUnfinishedChestplate, 1, 0),
				new ItemStack(TFCItems.blueSteelSheet2x), true, AnvilReq.BLACKSTEEL,
				new ItemStack(TFCItems.blueSteelUnfinishedChestplate, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.bronzeUnfinishedChestplate, 1, 0),
				new ItemStack(TFCItems.bronzeSheet2x), true, AnvilReq.COPPER,
				new ItemStack(TFCItems.bronzeUnfinishedChestplate, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.copperUnfinishedChestplate, 1, 0),
				new ItemStack(TFCItems.copperSheet2x), true, AnvilReq.STONE,
				new ItemStack(TFCItems.copperUnfinishedChestplate, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronUnfinishedChestplate, 1, 0),
				new ItemStack(TFCItems.wroughtIronSheet2x), true, AnvilReq.BRONZE,
				new ItemStack(TFCItems.wroughtIronUnfinishedChestplate, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.redSteelUnfinishedChestplate, 1, 0),
				new ItemStack(TFCItems.redSteelSheet2x), true, AnvilReq.BLACKSTEEL,
				new ItemStack(TFCItems.redSteelUnfinishedChestplate, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.steelUnfinishedChestplate, 1, 0),
				new ItemStack(TFCItems.steelSheet2x), true, AnvilReq.WROUGHTIRON,
				new ItemStack(TFCItems.steelUnfinishedChestplate, 1, 1)));

		// greaves
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeUnfinishedGreaves, 1, 0),
				new ItemStack(TFCItems.bismuthBronzeSheet), true, AnvilReq.COPPER,
				new ItemStack(TFCItems.bismuthBronzeUnfinishedGreaves, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackBronzeUnfinishedGreaves, 1, 0),
				new ItemStack(TFCItems.blackBronzeSheet), true, AnvilReq.COPPER,
				new ItemStack(TFCItems.blackBronzeUnfinishedGreaves, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelUnfinishedGreaves, 1, 0),
				new ItemStack(TFCItems.blackSteelSheet), true, AnvilReq.STEEL,
				new ItemStack(TFCItems.blackSteelUnfinishedGreaves, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.blueSteelUnfinishedGreaves, 1, 0),
				new ItemStack(TFCItems.blueSteelSheet), true, AnvilReq.BLACKSTEEL,
				new ItemStack(TFCItems.blueSteelUnfinishedGreaves, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.bronzeUnfinishedGreaves, 1, 0),
				new ItemStack(TFCItems.bronzeSheet), true, AnvilReq.COPPER,
				new ItemStack(TFCItems.bronzeUnfinishedGreaves, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.copperUnfinishedGreaves, 1, 0),
				new ItemStack(TFCItems.copperSheet), true, AnvilReq.STONE,
				new ItemStack(TFCItems.copperUnfinishedGreaves, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronUnfinishedGreaves, 1, 0),
				new ItemStack(TFCItems.wroughtIronSheet), true, AnvilReq.BRONZE,
				new ItemStack(TFCItems.wroughtIronUnfinishedGreaves, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.redSteelUnfinishedGreaves, 1, 0),
				new ItemStack(TFCItems.redSteelSheet), true, AnvilReq.BLACKSTEEL,
				new ItemStack(TFCItems.redSteelUnfinishedGreaves, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.steelUnfinishedGreaves, 1, 0),
				new ItemStack(TFCItems.steelSheet), true, AnvilReq.WROUGHTIRON,
				new ItemStack(TFCItems.steelUnfinishedGreaves, 1, 1)));

		// Helmet
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeUnfinishedHelmet, 1, 0),
				new ItemStack(TFCItems.bismuthBronzeSheet), true, AnvilReq.COPPER,
				new ItemStack(TFCItems.bismuthBronzeUnfinishedHelmet, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackBronzeUnfinishedHelmet, 1, 0),
				new ItemStack(TFCItems.blackBronzeSheet), true, AnvilReq.COPPER,
				new ItemStack(TFCItems.blackBronzeUnfinishedHelmet, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelUnfinishedHelmet, 1, 0),
				new ItemStack(TFCItems.blackSteelSheet), true, AnvilReq.STEEL,
				new ItemStack(TFCItems.blackSteelUnfinishedHelmet, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.blueSteelUnfinishedHelmet, 1, 0),
				new ItemStack(TFCItems.blueSteelSheet), true, AnvilReq.BLACKSTEEL,
				new ItemStack(TFCItems.blueSteelUnfinishedHelmet, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.bronzeUnfinishedHelmet, 1, 0),
				new ItemStack(TFCItems.bronzeSheet), true, AnvilReq.COPPER,
				new ItemStack(TFCItems.bronzeUnfinishedHelmet, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.copperUnfinishedHelmet, 1, 0),
				new ItemStack(TFCItems.copperSheet), true, AnvilReq.STONE,
				new ItemStack(TFCItems.copperUnfinishedHelmet, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronUnfinishedHelmet, 1, 0),
				new ItemStack(TFCItems.wroughtIronSheet), true, AnvilReq.BRONZE,
				new ItemStack(TFCItems.wroughtIronUnfinishedHelmet, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.redSteelUnfinishedHelmet, 1, 0),
				new ItemStack(TFCItems.redSteelSheet), true, AnvilReq.BLACKSTEEL,
				new ItemStack(TFCItems.redSteelUnfinishedHelmet, 1, 1)));
		manager.addWeldRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.steelUnfinishedHelmet, 1, 0), new ItemStack(TFCItems.steelSheet),
						true, AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.steelUnfinishedHelmet, 1, 1)));

		// Boots
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.bismuthBronzeUnfinishedBoots, 1, 0),
				new ItemStack(TFCItems.bismuthBronzeSheet), true, AnvilReq.COPPER,
				new ItemStack(TFCItems.bismuthBronzeUnfinishedBoots, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackBronzeUnfinishedBoots, 1, 0),
				new ItemStack(TFCItems.blackBronzeSheet), true, AnvilReq.COPPER,
				new ItemStack(TFCItems.blackBronzeUnfinishedBoots, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.blackSteelUnfinishedBoots, 1, 0),
				new ItemStack(TFCItems.blackSteelSheet), true, AnvilReq.STEEL,
				new ItemStack(TFCItems.blackSteelUnfinishedBoots, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.blueSteelUnfinishedBoots, 1, 0),
				new ItemStack(TFCItems.blueSteelSheet), true, AnvilReq.BLACKSTEEL,
				new ItemStack(TFCItems.blueSteelUnfinishedBoots, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.bronzeUnfinishedBoots, 1, 0),
				new ItemStack(TFCItems.bronzeSheet), true, AnvilReq.COPPER,
				new ItemStack(TFCItems.bronzeUnfinishedBoots, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.copperUnfinishedBoots, 1, 0),
				new ItemStack(TFCItems.copperSheet), true, AnvilReq.STONE,
				new ItemStack(TFCItems.copperUnfinishedBoots, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.wroughtIronUnfinishedBoots, 1, 0),
				new ItemStack(TFCItems.wroughtIronSheet), true, AnvilReq.BRONZE,
				new ItemStack(TFCItems.wroughtIronUnfinishedBoots, 1, 1)));
		manager.addWeldRecipe(new AnvilRecipe(new ItemStack(TFCItems.redSteelUnfinishedBoots, 1, 0),
				new ItemStack(TFCItems.redSteelSheet), true, AnvilReq.BLACKSTEEL,
				new ItemStack(TFCItems.redSteelUnfinishedBoots, 1, 1)));
		manager.addWeldRecipe(
				new AnvilRecipe(new ItemStack(TFCItems.steelUnfinishedBoots, 1, 0), new ItemStack(TFCItems.steelSheet),
						true, AnvilReq.WROUGHTIRON, new ItemStack(TFCItems.steelUnfinishedBoots, 1, 1)));
	}
	...
	public static void registerFoodRecipes()
	{
		...
		for (Item i : TFCItems.foodList)
		{
			...
			GameRegistry.addRecipe(new ShapelessOreRecipe(ItemFoodTFC.createTag(new ItemStack(i, 1)),
					ItemFoodTFC.createTag(new ItemStack(i, 1)), "itemKnife"));
			GameRegistry.addShapelessRecipe(ItemFoodTFC.createTag(new ItemStack(i, 1)),
	...
	{
		GameRegistry.addShapelessRecipe(ItemFoodTFC.createTag(new ItemStack(food, 1)),
				ItemFoodTFC.createTag(new ItemStack(food, 1)), new ItemStack(TFCItems.powder, 1, 9));
	}
	...
	public static void addFoodRefineRecipe(Item foodInput, Item foodOutput)
	{
		GameRegistry.addRecipe(new ShapelessOreRecipe(ItemFoodTFC.createTag(new ItemStack(foodOutput, 1)),
				ItemFoodTFC.createTag(new ItemStack(foodInput, 1)), "itemKnife"));
	}

	public static void addFoodRefineRecipe(Block foodInput, Item foodOutput)
	{
		GameRegistry.addRecipe(new ShapelessOreRecipe(ItemFoodTFC.createTag(new ItemStack(foodOutput, 1)),
				ItemFoodTFC.createTag(new ItemStack(foodInput, 1)), "itemKnife"));
	}

	public static void addFoodRefineRecipe(Block foodInput, int inputMeta, Item foodOutput, int outputMeta)
	{
		GameRegistry.addRecipe(new ShapelessOreRecipe(ItemFoodTFC.createTag(new ItemStack(foodOutput, 1, outputMeta)),
				ItemFoodTFC.createTag(new ItemStack(foodInput, 1, inputMeta)), "itemKnife"));
	}

	public static void addFoodDoughRecipe(Item foodInput, Item foodOutput, Item bucket)
	{
		GameRegistry.addShapelessRecipe(ItemFoodTFC.createTag(new ItemStack(foodOutput, 1)),
				ItemFoodTFC.createTag(new ItemStack(foodInput, 1)), bucket);
	}

	public static void addFoodMergeRecipe(Item food)
	{
		GameRegistry.addShapelessRecipe(ItemFoodTFC.createTag(new ItemStack(food, 1)),
				ItemFoodTFC.createTag(new ItemStack(food, 1)), ItemFoodTFC.createTag(new ItemStack(food, 1)));
		GameRegistry.addShapelessRecipe(ItemFoodTFC.createTag(new ItemStack(food, 1)),
				ItemFoodTFC.createTag(new ItemStack(food, 1)), ItemFoodTFC.createTag(new ItemStack(food, 1)),
	...
	public static void registerKilnRecipes()
	{
		...
		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.ceramicMold, 1, 0), 0,
				new ItemStack(TFCItems.ceramicMold, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.spindleHead, 1, 0), 0,
		...
		/*
		 * manager.addRecipe( new KilnRecipe( new
		 * ItemStack(TFCItems.PotteryPot,1,0), 0, new
		 * ItemStack(TFCItems.PotteryPot,1,1)));
		 */

		manager.addRecipe(
				new KilnRecipe(new ItemStack(TFCBlocks.vessel, 1, 0), 0, new ItemStack(TFCBlocks.vessel, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayMoldSheet, 1, 0), 0,
				new ItemStack(TFCItems.clayMoldSheet, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayBlowpipe, 1, 0), 0,
				new ItemStack(TFCItems.clayBlowpipe, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayMoldAxe, 1, 0), 0,
				new ItemStack(TFCItems.clayMoldAxe, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayMoldAxe, 1, 0), 0,
				new ItemStack(TFCItems.clayMoldAxe, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayMoldChisel, 1, 0), 0,
				new ItemStack(TFCItems.clayMoldChisel, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayMoldHammer, 1, 0), 0,
				new ItemStack(TFCItems.clayMoldHammer, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayMoldHoe, 1, 0), 0,
				new ItemStack(TFCItems.clayMoldHoe, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayMoldKnife, 1, 0), 0,
				new ItemStack(TFCItems.clayMoldKnife, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayMoldMace, 1, 0), 0,
				new ItemStack(TFCItems.clayMoldMace, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayMoldPick, 1, 0), 0,
				new ItemStack(TFCItems.clayMoldPick, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayMoldProPick, 1, 0), 0,
				new ItemStack(TFCItems.clayMoldProPick, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayMoldTrowel, 1, 0), 0,
				new ItemStack(TFCItems.clayMoldTrowel, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayMoldSaw, 1, 0), 0,
				new ItemStack(TFCItems.clayMoldSaw, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayMoldScythe, 1, 0), 0,
				new ItemStack(TFCItems.clayMoldScythe, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayMoldShovel, 1, 0), 0,
				new ItemStack(TFCItems.clayMoldShovel, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayMoldSword, 1, 0), 0,
				new ItemStack(TFCItems.clayMoldSword, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.clayMoldJavelin, 1, 0), 0,
				new ItemStack(TFCItems.clayMoldJavelin, 1, 1)));

		manager.addRecipe(
				new KilnRecipe(new ItemStack(TFCItems.fireBrick, 1, 0), 0, new ItemStack(TFCItems.fireBrick, 1, 1)));

		manager.addRecipe(new KilnRecipe(new ItemStack(TFCItems.potteryBowl, 1, 0), 0,
				new ItemStack(TFCItems.potteryBowl, 1, 1)));
	}
	...
	private static void registerQuernRecipes()
	{
		...
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.wheatGrain, 1), new ItemStack(TFCItems.wheatGround, 1)));// Wheat
																												// Flour
		...
		manager.addRecipe(new QuernRecipe(new ItemStack(TFCItems.riceGrain, 1), new ItemStack(TFCItems.riceGround, 1)));// Rice
																														// Flour
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.maizeEar, 1), new ItemStack(TFCItems.cornmealGround, 1)));// Cornmeal
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.oreChunk, 1, 16), new ItemStack(TFCItems.powder, 4, 1)));// Kaolinite
																												// Powder
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.oreChunk, 1, 17), new ItemStack(TFCItems.powder, 1, 11)));// Gypsum
																													// Powder
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.oreChunk, 1, 20), new ItemStack(TFCItems.powder, 4, 2)));// Graphite
																												// Powder
		...
		manager.addRecipe(new QuernRecipe(new ItemStack(TFCItems.oreChunk, 1, 28), new ItemStack(Items.redstone, 8)));// Cryolite
																														// to
																														// Redstone
		manager.addRecipe(new QuernRecipe(new ItemStack(TFCItems.bone, 1), new ItemStack(TFCItems.dye, 2, 15)));// Bone
		// Meal
		manager.addRecipe(new QuernRecipe(new ItemStack(TFCItems.boneFragment, 1), new ItemStack(TFCItems.dye, 2, 15)));// Bone
																														// Meal
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.oreChunk, 1, 34), new ItemStack(TFCItems.powder, 4, 6)));// Lapis
																												// Powder
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.smallOreChunk, 1, 9), new ItemStack(TFCItems.powder, 1, 8)));// Small
																													...
																													// Powder
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.oreChunk, 1, 58), new ItemStack(TFCItems.powder, 2, 8)));// Poor
																												// Malachite
																												// Powder
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.oreChunk, 1, 9), new ItemStack(TFCItems.powder, 4, 8)));// Malachite
																												// Powder
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.oreChunk, 1, 44), new ItemStack(TFCItems.powder, 6, 8)));// Rich
																												// Malachite
																												// Powder
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.smallOreChunk, 1, 3), new ItemStack(TFCItems.powder, 1, 5)));// Small
																													...
																													// Powder
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.oreChunk, 1, 52), new ItemStack(TFCItems.powder, 2, 5)));// Poor
																												// Hematite
																												// Powder
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.oreChunk, 1, 3), new ItemStack(TFCItems.powder, 4, 5)));// Hematite
																												// Powder
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.oreChunk, 1, 38), new ItemStack(TFCItems.powder, 6, 5)));// Rich
																												// Hematite
																												// Powder
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.smallOreChunk, 1, 11), new ItemStack(TFCItems.powder, 1, 7)));// Small
																														...
																														// Powder
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.oreChunk, 1, 60), new ItemStack(TFCItems.powder, 2, 7)));// Poor
																												// Limonite
																												// Powder
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.oreChunk, 1, 11), new ItemStack(TFCItems.powder, 4, 7)));// Limonite
																												// Powder
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.oreChunk, 1, 46), new ItemStack(TFCItems.powder, 6, 7)));// Rich
																												// Limonite
																												// Powder
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.oreChunk, 1, 31), new ItemStack(TFCItems.powder, 4, 10)));// Sylvite
																													// to
																													// Sylvite
																													// powder,
																													// not
																													// Fertilizer
		manager.addRecipe(
				new QuernRecipe(new ItemStack(TFCItems.looseRock, 1, 5), new ItemStack(TFCItems.powder, 4, 9)));// Rock
																												// Salt
																												// to
																												// Salt
	}
