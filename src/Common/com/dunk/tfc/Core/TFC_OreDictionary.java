...
public class TFC_OreDictionary
{
	public static void registerOreDict()
	{
		...
		OreDictionary.registerOre("boneNeedle", new ItemStack(TFCItems.boneNeedle));
		...
		OreDictionary.registerOre("materialString", new ItemStack(TFCItems.silkString));
		OreDictionary.registerOre("materialString", new ItemStack(TFCItems.linenString));
		...
		OreDictionary.registerOre("materialCloth", new ItemStack(TFCItems.linenCloth));
		OreDictionary.registerOre("materialWool", new ItemStack(TFCItems.wool, 1, WILD));
		
		OreDictionary.registerOre("materialBurlap", new ItemStack(TFCItems.burlapCloth));
		...
		for (Item trowel : Recipes.trowels)
			OreDictionary.registerOre("itemTrowel", new ItemStack(trowel, 1, WILD));

		OreDictionary.registerOre("itemTrowelBismuthBronze", new ItemStack(TFCItems.trowelBismuthBronze, 1, WILD));
		OreDictionary.registerOre("itemTrowelBlackBronze", new ItemStack(TFCItems.trowelBlackBronze, 1, WILD));
		OreDictionary.registerOre("itemTrowelBlackSteel", new ItemStack(TFCItems.trowelBlackSteel, 1, WILD));
		OreDictionary.registerOre("itemTrowelBlueSteel", new ItemStack(TFCItems.trowelBlueSteel, 1, WILD));
		OreDictionary.registerOre("itemTrowelBronze", new ItemStack(TFCItems.trowelBronze, 1, WILD));
		OreDictionary.registerOre("itemTrowelCopper", new ItemStack(TFCItems.trowelCopper, 1, WILD));
		OreDictionary.registerOre("itemTrowelWroughtIron", new ItemStack(TFCItems.trowelIron, 1, WILD));
		OreDictionary.registerOre("itemTrowelRedSteel", new ItemStack(TFCItems.trowelRedSteel, 1, WILD));
		OreDictionary.registerOre("itemTrowelSteel", new ItemStack(TFCItems.trowelSteel, 1, WILD));
