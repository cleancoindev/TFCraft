...
public class ItemHeat
{
	...
	public static void setupItemHeat()
	{
		 ...
		 * that's way too quick! Gonna change it.
		 */

		final int WILDCARD_VALUE = OreDictionary.WILDCARD_VALUE;

		HeatRaw bismuthRaw = new HeatRaw(0.123, 270);
		...
		HeatRaw brassRaw = new HeatRaw(0.38, 930);
		HeatRaw bronzeRaw = new HeatRaw(0.35, 950);
		HeatRaw copperRaw = new HeatRaw(0.385, 1080);
		HeatRaw goldRaw = new HeatRaw(0.129, 1060);
		HeatRaw ironRaw = new HeatRaw(0.45, 1535);
		HeatRaw leadRaw = new HeatRaw(0.128, 328);
		...
		HeatRaw silverRaw = new HeatRaw(0.233, 961);
		...
		//GlassMaking
		HeatRaw glassRaw = new HeatRaw(0.84, 900);
		HeatRaw limeRaw = new HeatRaw(0.75, 2613);
		HeatRaw sodaRaw = new HeatRaw(1.18,1132);
		HeatRaw silicaRaw = new HeatRaw(0.53,1713);
		
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.clayMoldSheet,1,5), glassRaw,new ItemStack(TFCItems.clayMoldSheet,1),5,2));
		...
		//Glass Making
		//Silica
		manager.addIndex(new HeatIndex(new ItemStack(TFCBlocks.sand,1,0), silicaRaw,new ItemStack(TFCItems.moltenSilica,1))); //Granite
		manager.addIndex(new HeatIndex(new ItemStack(TFCBlocks.sand,1,9), silicaRaw,new ItemStack(TFCItems.moltenSilica,1))); //Chert
		manager.addIndex(new HeatIndex(new ItemStack(TFCBlocks.sand,1,11), silicaRaw,new ItemStack(TFCItems.moltenSilica,1))); //Rhyolite
		manager.addIndex(new HeatIndex(new ItemStack(TFCBlocks.sand,1,15), silicaRaw,new ItemStack(TFCItems.moltenSilica,1))); //Quartzite
		manager.addIndex(new HeatIndex(new ItemStack(TFCBlocks.sand2,1,1), silicaRaw,new ItemStack(TFCItems.moltenSilica,1))); //Phyllite
		
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.lime,1,0), limeRaw, null));
		...
		//Bismuth Bronze
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.clayMoldSheet,1,3), bismuthBronzeRaw,new ItemStack(TFCItems.clayMoldSheet,1),5,2));
		...
		//Black Bronze
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.clayMoldSheet,1,4), blackBronzeRaw,new ItemStack(TFCItems.clayMoldSheet,1),5,2));
		...
		//Copper
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.clayMoldSheet,1,1), copperRaw,new ItemStack(TFCItems.clayMoldSheet,1),5,2));
		...
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.potterySmallVessel, 1,1), 1, 6000, new ItemStack(TFCItems.potterySmallVessel, 1,1)).setKeepNBT(true));
		//manager.addIndex(new HeatIndex(new ItemStack(TFCItems.potterySmallVessel, 1,2), 1, 6000, new ItemStack(TFCItems.potterySmallVessel, 1,2)).setKeepNBT(true));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.powder, 1,11), 1, 150, new ItemStack(TFCItems.powder, 1,12)).setKeepNBT(true));
		//Turning Flux rocks into Lime
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.looseRock,1,Global.STONE_FLUXINDEX[0]), 1, 900, new ItemStack(TFCItems.lime, 1,0)).setKeepNBT(false));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.looseRock,1,Global.STONE_FLUXINDEX[1]), 1, 900, new ItemStack(TFCItems.lime, 1,0)).setKeepNBT(false));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.looseRock,1,Global.STONE_FLUXINDEX[2]), 1, 900, new ItemStack(TFCItems.lime, 1,0)).setKeepNBT(false));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.looseRock,1,Global.STONE_FLUXINDEX[3]), 1, 900, new ItemStack(TFCItems.lime, 1,0)).setKeepNBT(false));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.seashell,1,0), 1, 900, new ItemStack(TFCItems.lime, 1,0)).setKeepNBT(false));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.seashell,1,1), 1, 900, new ItemStack(TFCItems.lime, 1,0)).setKeepNBT(false));
		
		//Turning Flux Sand and Gravel into Lime
		manager.addIndex(new HeatIndex(new ItemStack(TFCBlocks.sand,1,Global.STONE_FLUXINDEX[0]), 1, 900, new ItemStack(TFCItems.lime, 5,0)).setKeepNBT(false));
		manager.addIndex(new HeatIndex(new ItemStack(TFCBlocks.sand,1,Global.STONE_FLUXINDEX[1]), 1, 900, new ItemStack(TFCItems.lime, 5,0)).setKeepNBT(false));
		manager.addIndex(new HeatIndex(new ItemStack(TFCBlocks.sand,1,Global.STONE_FLUXINDEX[2]), 1, 900, new ItemStack(TFCItems.lime, 5,0)).setKeepNBT(false));
		manager.addIndex(new HeatIndex(new ItemStack(TFCBlocks.sand2,1,Global.STONE_FLUXINDEX[3]-16), 1, 900, new ItemStack(TFCItems.lime, 5,0)).setKeepNBT(false));
		
		manager.addIndex(new HeatIndex(new ItemStack(TFCBlocks.gravel,1,Global.STONE_FLUXINDEX[0]), 1, 900, new ItemStack(TFCItems.lime, 5,0)).setKeepNBT(false));
		manager.addIndex(new HeatIndex(new ItemStack(TFCBlocks.gravel,1,Global.STONE_FLUXINDEX[1]), 1, 900, new ItemStack(TFCItems.lime, 5,0)).setKeepNBT(false));
		manager.addIndex(new HeatIndex(new ItemStack(TFCBlocks.gravel,1,Global.STONE_FLUXINDEX[2]), 1, 900, new ItemStack(TFCItems.lime, 5,0)).setKeepNBT(false));
		manager.addIndex(new HeatIndex(new ItemStack(TFCBlocks.gravel2,1,Global.STONE_FLUXINDEX[3]-16), 1, 900, new ItemStack(TFCItems.lime, 5,0)).setKeepNBT(false));
		...
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.mushroomFoodB, 1), 1, 1200, null));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.mushroomFoodR, 1), 1, 1200, null));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.pumpkinGuts, 1), 1, 1200, null));
