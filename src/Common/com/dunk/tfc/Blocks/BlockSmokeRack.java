...
public class BlockSmokeRack extends BlockTerraContainer
{
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int metadata)
	{
		...
		if(te != null)
		{
			...
			Item i = null;
			if(te != null && te instanceof TESmokeRack)
			{
				i = ((TESmokeRack)te).stringItem;
				if(i != null)
				{
					EntityItem ei = new EntityItem(world, x+0.5, y+0.5, z+0.5, new ItemStack(i));
					ei.motionX = 0;
					ei.motionY = 0;
					ei.motionZ = 0;
					world.spawnEntityInWorld(ei);
				...
				{				
					EntityItem ei = new EntityItem(world, x+0.5, y+0.5, z+0.5, new ItemStack(TFCItems.woolYarn));
					ei.motionX = 0;
					ei.motionY = 0;
					ei.motionZ = 0;
					world.spawnEntityInWorld(ei);
	...
	public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z)
	{
		...
		if(te != null && te instanceof TESmokeRack)
		{
			Item i = ((TESmokeRack)te).stringItem;
			if(i != null)
			{
