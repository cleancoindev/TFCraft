...
public class RenderBasket implements ISimpleBlockRenderingHandler
{
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer)
	{
		...
		if((te.rotation & -128) == 0)
		{
			...
			{
				renderer.setRenderBounds(MIN+0.05F, 0+0.15f, MIN+0.05F, MAX-0.05F, 0.05F+0.15f, MAX-0.05F);
				renderer.renderStandardBlock(block, x, y, z);
			...
			renderer.setRenderBounds(MIN, 0F+0.15f, MIN+0.05F, MIN+0.05F, 0.6F+0.15f, MAX-0.05F);
			renderer.renderStandardBlock(block, x, y, z);

			renderer.setRenderBounds(MAX-0.05F, 0F+0.15f, MIN+0.05F, MAX, 0.6F+0.15f, MAX-0.05F);
			renderer.renderStandardBlock(block, x, y, z);

			renderer.setRenderBounds(MIN, 0F+0.15f, MIN, MAX, 0.6F+0.15f, MIN+0.05F);
			renderer.renderStandardBlock(block, x, y, z);

			renderer.setRenderBounds(MIN, 0F+0.15f, MAX-0.05F, MAX, 0.6F+0.15f, MAX);
			renderer.renderStandardBlock(block, x, y, z);

			renderer.setRenderBounds(MIN+0.05F, 0.05f+0.15f, MIN+0.05F, MAX-0.05F, 0.1f+0.15f, MAX-0.05F);
			renderer.renderStandardBlock(block, x, y, z);
