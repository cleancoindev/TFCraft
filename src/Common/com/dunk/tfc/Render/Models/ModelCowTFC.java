...
public class ModelCowTFC extends ModelQuadruped
{
	...
	public void render(Entity entity, float par2, float par3, float par4, float par5, float par6, float par7)
	{
		...
		{
			percent = TFC_Core.getPercentGrown((IAnimal)entity);
			gender = ((IAnimal)entity).getGender();
		}
		else if(entity instanceof EntityCorpse)
		{
			percent = ((EntityCorpse)entity).getAnimalNBT().getFloat("Growth");
			gender = GenderEnum.GENDERS[((EntityCorpse)entity).getAnimalNBT().getInteger("Sex")];
		}
