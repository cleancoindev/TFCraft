...
{
	public static final String MOD_ID = "terrafirmacraftplus";
	public static final String MOD_NAME = "TerraFirmaCraft+";

	public static final int VERSION_MAJOR = 0;
	public static final int VERSION_MINOR = 81;
	...
	public static final String SERVER_PROXY_CLASS = "com.dunk.tfc.CommonProxy";
	public static final String CLIENT_PROXY_CLASS = "com.dunk.tfc.ClientProxy";

	public static final String ASSET_PATH = "/assets/" + MOD_ID + "/";
	public static final String ASSET_PATH_GUI = "textures/gui/";
	public static final String ASSET_PATH_ITEM = "textures/items/";

	public static final String GUI_FACTORY = "com.dunk.tfc.Core.Config.TFC_GuiFactory";
}
