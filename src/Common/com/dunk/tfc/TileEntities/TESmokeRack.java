...
public class TESmokeRack extends NetworkTileEntity implements IInventory
{
	...
	public void readFromNBT(NBTTagCompound nbt) 
	{
		...
		TFC_Core.readInventoryFromNBT(nbt, is, "string");
		if(is != null && is[0] != null)
		{
			stringItem = is[0].getItem();
		}
	}
	...
	public void writeToNBT(NBTTagCompound nbt) 
	{
		...
		TFC_Core.writeInventoryToNBT(nbt, new ItemStack[]{new ItemStack(stringItem)},"string");
