...
import com.dunk.tfc.Render.Models.ModelLoom;
...
public class TELoom extends NetworkTileEntity implements IInventory
{
	...
	public static void registerRecipes()
	{
		...
		LoomManager.getInstance().addRecipe(new LoomRecipe(new ItemStack(TFCItems.silkString,24), new ItemStack(TFCItems.silkCloth,1)),new ResourceLocation(Reference.MOD_ID, "textures/blocks/Silk.png"));
		LoomManager.getInstance().addRecipe(new LoomRecipe(new ItemStack(TFCItems.linenString,18), new ItemStack(TFCItems.linenCloth,1)),new ResourceLocation(Reference.MOD_ID, "textures/blocks/linenCloth.png"));
