package com.dunk.tfc.api.Constant;
...
public class Global
{
	...
	public static final int RED_DYE_VALUE = 16693934; //#FEBAAE
	public static final int BLUE_DYE_VALUE = 10475006; //#9FD5FE
	public static final int YELLOW_DYE_VALUE = 16707758; //#FEF0AE
	public static final int WHITE_DYE_VALUE = 16777215;//#FFFFFF
	public static final int BLACK_DYE_VALUE = 8421504;//#808080
	...
	public static Metal LIME;
	public static Metal SODA;
	public static Metal SILICA;
	public static Metal GLASS;
	
	//Garbage metal
	public static Metal GARBAGE;
