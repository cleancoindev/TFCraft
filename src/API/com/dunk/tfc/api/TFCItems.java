...
public class TFCItems
{
	...
	//Clothing Components
	public static Item saddlePiece;
	public static Item quiverPiece;
	public static Item hatPiece;
	public static Item shirtSleeves;
	public static Item shirtBody;
	public static Item pantsPiece;
	public static Item bootSole;
	public static Item leatherStrap;
	public static Item sockCloth;
	public static Item coatBodyFront;
	public static Item coatBodyBack;
	public static Item bootTop;
	
	public static Item saddleTFC;
	
	//Wool
	public static Item woolSocks;
	...
	//Fur
	public static Item wolfFurBoots;
	public static Item wolfFurCoat;
	public static Item wolfFurHat;
	
	public static Item bearFurBoots;
	public static Item bearFurCoat;
	public static Item bearFurHat;
	...
	public static Item bismuthBronzeTrowelHead;
	public static Item blackBronzeTrowelHead;
	public static Item blackSteelTrowelHead;
	public static Item blueSteelTrowelHead;
	public static Item bronzeTrowelHead;
	public static Item copperTrowelHead;
	public static Item wroughtIronTrowelHead;
	public static Item redSteelTrowelHead;
	public static Item steelTrowelHead;
	...
	//Glass Making items
	public static Item solidifiedGlass;
	public static Item moltenGlass;
	public static Item moltenSilica;
	public static Item silica;
	public static Item moltenLime;
	public static Item lime;
	public static Item moltenSoda;
	...
	public static Item trowelBismuthBronze;
	public static Item trowelBlackBronze;
	public static Item trowelBlackSteel;
	public static Item trowelBlueSteel;
	public static Item trowelBronze;
	public static Item trowelCopper;
	public static Item trowelIron;
	public static Item trowelRedSteel;
	public static Item trowelSteel;
	...
	public static Item woodenBucketPlaster;
	public static Item woodenBucketGypsum;
	...
	public static Item linenString;
	public static Item silkString;
	...
	public static Item flatWool;
	public static Item flatLinen;
	public static Item flatSilk;
	public static Item flatWolfFur;
	public static Item flatBearFur;
	public static Item flatStraw;
	
	public static Item boneNeedle;
	public static Item ironNeedle;
	public static Item boneNeedleStrung;
	public static Item ironNeedleStrung;
	...
	public static Item clayMoldSheet;
	public static Item clayBlowpipe;
	...
	public static Item clayMoldTrowel;
	...
	public static Item madderRoot;
	public static Item weldRoot;
	public static Item woadLeaves;
	 ...
	 * Item Uses Setup
	 * */
	public static int woolUses = 128;
	public static int linenUses = 128;
	public static int strawUses = 32;
	public static int furUses = 64;
	public static int silkUses = 512;
	public static int leatherUses = 256;
	...
	public static float boneEff = 4.0f;
	...
	public static void registerItems()
	{
		...
		GameRegistry.registerItem(trowelBismuthBronze, trowelBismuthBronze.getUnlocalizedName());
		GameRegistry.registerItem(trowelBlackBronze, trowelBlackBronze.getUnlocalizedName());
		GameRegistry.registerItem(trowelBlackSteel, trowelBlackSteel.getUnlocalizedName());
		GameRegistry.registerItem(trowelBlueSteel, trowelBlueSteel.getUnlocalizedName());
		GameRegistry.registerItem(trowelBronze, trowelBronze.getUnlocalizedName());
		GameRegistry.registerItem(trowelCopper, trowelCopper.getUnlocalizedName());
		GameRegistry.registerItem(trowelIron, trowelIron.getUnlocalizedName());
		GameRegistry.registerItem(trowelRedSteel, trowelRedSteel.getUnlocalizedName());
		GameRegistry.registerItem(trowelSteel, trowelSteel.getUnlocalizedName());
		...
		GameRegistry.registerItem(thickLogs, thickLogs.getUnlocalizedName());
		...
		GameRegistry.registerItem(bismuthBronzeTrowelHead, bismuthBronzeTrowelHead.getUnlocalizedName());
		GameRegistry.registerItem(blackBronzeTrowelHead, blackBronzeTrowelHead.getUnlocalizedName());
		GameRegistry.registerItem(blackSteelTrowelHead, blackSteelTrowelHead.getUnlocalizedName());
		GameRegistry.registerItem(blueSteelTrowelHead, blueSteelTrowelHead.getUnlocalizedName());
		GameRegistry.registerItem(bronzeTrowelHead, bronzeTrowelHead.getUnlocalizedName());
		GameRegistry.registerItem(copperTrowelHead, copperTrowelHead.getUnlocalizedName());
		GameRegistry.registerItem(wroughtIronTrowelHead, wroughtIronTrowelHead.getUnlocalizedName());
		GameRegistry.registerItem(redSteelTrowelHead, redSteelTrowelHead.getUnlocalizedName());
		GameRegistry.registerItem(steelTrowelHead, steelTrowelHead.getUnlocalizedName());
		...
		//Clothing
		GameRegistry.registerItem(saddlePiece, saddlePiece.getUnlocalizedName());
		GameRegistry.registerItem(quiverPiece, quiverPiece.getUnlocalizedName());
		GameRegistry.registerItem(hatPiece, hatPiece.getUnlocalizedName());
		GameRegistry.registerItem(shirtSleeves, shirtSleeves.getUnlocalizedName());
		GameRegistry.registerItem(shirtBody, shirtBody.getUnlocalizedName());
		GameRegistry.registerItem(pantsPiece, pantsPiece.getUnlocalizedName());
		GameRegistry.registerItem(bootSole, bootSole.getUnlocalizedName());
		GameRegistry.registerItem(leatherStrap, leatherStrap.getUnlocalizedName());
		GameRegistry.registerItem(sockCloth, sockCloth.getUnlocalizedName());
		GameRegistry.registerItem(coatBodyFront, coatBodyFront.getUnlocalizedName());
		GameRegistry.registerItem(coatBodyBack, coatBodyBack.getUnlocalizedName());
		GameRegistry.registerItem(bootTop, bootTop.getUnlocalizedName());
		
		GameRegistry.registerItem(saddleTFC, saddleTFC.getUnlocalizedName());
		
		//Wool
		GameRegistry.registerItem(woolSocks, woolSocks.getUnlocalizedName());
		...
		//Linen
		GameRegistry.registerItem(linenSocks, linenSocks.getUnlocalizedName());
		...
		//Silk
		GameRegistry.registerItem(silkSocks, silkSocks.getUnlocalizedName());
		...
		//Fur
		GameRegistry.registerItem(wolfFurBoots, wolfFurBoots.getUnlocalizedName());
		GameRegistry.registerItem(wolfFurCoat, wolfFurCoat.getUnlocalizedName());
		GameRegistry.registerItem(wolfFurHat, wolfFurHat.getUnlocalizedName());
		
		GameRegistry.registerItem(bearFurBoots, bearFurBoots.getUnlocalizedName());
		GameRegistry.registerItem(bearFurCoat, bearFurCoat.getUnlocalizedName());
		GameRegistry.registerItem(bearFurHat, bearFurHat.getUnlocalizedName());
		...
		GameRegistry.registerItem(silkString, silkString.getUnlocalizedName());
		GameRegistry.registerItem(sinew, sinew.getUnlocalizedName());
		GameRegistry.registerItem(linenString, linenString.getUnlocalizedName());
		...
		GameRegistry.registerItem(linenCloth, linenCloth.getUnlocalizedName());
		GameRegistry.registerItem(wolfFur, wolfFur.getUnlocalizedName());
		GameRegistry.registerItem(bearFur, bearFur.getUnlocalizedName());
		...
		GameRegistry.registerItem(flatWool , flatWool.getUnlocalizedName());
		GameRegistry.registerItem(flatSilk , flatSilk.getUnlocalizedName());
		GameRegistry.registerItem(flatWolfFur, flatWolfFur.getUnlocalizedName());
		GameRegistry.registerItem(flatBearFur, flatBearFur.getUnlocalizedName());
		GameRegistry.registerItem(flatLinen , flatLinen.getUnlocalizedName());
		GameRegistry.registerItem(flatStraw, flatStraw.getUnlocalizedName());
		...
		GameRegistry.registerItem(boneNeedleStrung, boneNeedleStrung.getUnlocalizedName());
		GameRegistry.registerItem(ironNeedleStrung, ironNeedleStrung.getUnlocalizedName());
		...
		GameRegistry.registerItem(burlapSack, burlapSack.getUnlocalizedName());
		...
		GameRegistry.registerItem(clayBlowpipe, clayBlowpipe.getUnlocalizedName());
		...
		GameRegistry.registerItem(clayMoldTrowel , clayMoldTrowel.getUnlocalizedName());
		...
		GameRegistry.registerItem(flax , flax.getUnlocalizedName());
		GameRegistry.registerItem(madderRoot , madderRoot.getUnlocalizedName());
		GameRegistry.registerItem(weldRoot , weldRoot.getUnlocalizedName());
		GameRegistry.registerItem(woadLeaves , woadLeaves.getUnlocalizedName());
		GameRegistry.registerItem(flaxFiber , flaxFiber.getUnlocalizedName());
		...
		//Glass Making
		GameRegistry.registerItem(moltenGlass, moltenGlass.getUnlocalizedName());
		GameRegistry.registerItem(moltenSilica, moltenSilica.getUnlocalizedName());
		GameRegistry.registerItem(moltenSoda, moltenSoda.getUnlocalizedName());
		GameRegistry.registerItem(moltenLime, moltenLime.getUnlocalizedName());
		GameRegistry.registerItem(solidifiedGlass, solidifiedGlass.getUnlocalizedName());
		GameRegistry.registerItem(silica, silica.getUnlocalizedName());
		GameRegistry.registerItem(lime, lime.getUnlocalizedName());
		GameRegistry.registerItem(soda, soda.getUnlocalizedName());
		
		GameRegistry.registerItem(seashell, seashell.getUnlocalizedName());
