package com.dunk.tfc.api.TileEntities;
...
public class TEFireEntity extends NetworkTileEntity implements IHeatSourceTE
{
	...
	public boolean canBlowWithPipe()
	{
		return airFromBellows < (3f*AIRTOADD/4);
	}
	
	public void receiveAirFromPipe()
	{
		if(airFromBellows < AIRTOADD)
		{
