package com.dunk.tfc.ASM.Transform;
...
import com.dunk.tfc.ASM.ClassTransformer;
...
public class TF_EntityPlayer extends ClassTransformer
{
	...
	public TF_EntityPlayer()
	{
		...
		list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com/dunk/tfc/ServerOverrides","canPlayerMove","(Lnet/minecraft/entity/EntityLivingBase;)Z"));
